namespace CS2Dumper.Schemas {
    public static class Vphysics2Dll {
        ...
        public static class PhysFeModelDesc_t {
            ...
            public const nint m_SimdRodsAnim = 0x108;  
            public const nint m_InitPose = 0x120;  
            public const nint m_Rods = 0x138;  
            public const nint m_Twists = 0x150;  
            public const nint m_HingeLimits = 0x168;  
            public const nint m_AntiTunnelProbes = 0x180;  
            ...
            public const nint m_CollisionPlanes = 0x228;  
            public const nint m_NodeIntegrator = 0x240;  
            public const nint m_SpringIntegrator = 0x258;  
            ...
            public const nint m_TaperedCapsuleStretches = 0x318;  
            public const nint m_TaperedCapsuleRigids = 0x330;  
            ...
            public const nint m_ReverseOffsets = 0x408;  
            public const nint m_AnimStrayRadii = 0x420;  
            public const nint m_SimdAnimStrayRadii = 0x438;  
            public const nint m_KelagerBends = 0x450;  
            public const nint m_CtrlSoftOffsets = 0x468;  
            public const nint m_JiggleBones = 0x480;  
