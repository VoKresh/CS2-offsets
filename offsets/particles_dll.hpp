    ...
    namespace schemas {
        namespace particles_dll {
            ...
            namespace C_OP_RemapGravityToVector {
                ...
                constexpr std::ptrdiff_t m_nOutputField = 0x838;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x83C;  
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0x840;  
            }
            ...
            namespace C_OP_RenderDeferredLight {
                constexpr std::ptrdiff_t m_bUseAlphaTestWindow = 0x210;  
                constexpr std::ptrdiff_t m_bUseTexture = 0x211;  
                constexpr std::ptrdiff_t m_flRadiusScale = 0x214;  
                constexpr std::ptrdiff_t m_flAlphaScale = 0x218;  
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x21C;  
                constexpr std::ptrdiff_t m_vecColorScale = 0x220;  
                constexpr std::ptrdiff_t m_nColorBlendType = 0x898;  
                constexpr std::ptrdiff_t m_flLightDistance = 0x89C;  
                constexpr std::ptrdiff_t m_flStartFalloff = 0x8A0;  
                constexpr std::ptrdiff_t m_flDistanceFalloff = 0x8A4;  
                constexpr std::ptrdiff_t m_flSpotFoV = 0x8A8;  
                constexpr std::ptrdiff_t m_nAlphaTestPointField = 0x8AC;  
                constexpr std::ptrdiff_t m_nAlphaTestRangeField = 0x8B0;  
                constexpr std::ptrdiff_t m_nAlphaTestSharpnessField = 0x8B4;  
                constexpr std::ptrdiff_t m_hTexture = 0x8B8;  
                constexpr std::ptrdiff_t m_nHSVShiftControlPoint = 0x8C0;  
            }
            namespace C_OP_RemapSpeedtoCP {
                constexpr std::ptrdiff_t m_nInControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nOutControlPointNumber = 0x1CC;  
                ...
                constexpr std::ptrdiff_t m_bUseDeltaV = 0x1E4;  
            }
            ...
            namespace C_OP_SpringToVectorConstraint {
                ...
                constexpr std::ptrdiff_t m_flMinDistance = 0x320;  
                constexpr std::ptrdiff_t m_flMaxDistance = 0x480;  
                constexpr std::ptrdiff_t m_flRestingLength = 0x5E0;  
                constexpr std::ptrdiff_t m_vecAnchorVector = 0x740;  
            }
            namespace C_OP_RenderRopes {
                constexpr std::ptrdiff_t m_bEnableFadingAndClamping = 0x2AA8;  
                constexpr std::ptrdiff_t m_flMinSize = 0x2AAC;  
                constexpr std::ptrdiff_t m_flMaxSize = 0x2AB0;  
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x2AB4;  
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x2AB8;  
                constexpr std::ptrdiff_t m_flStartFadeDot = 0x2ABC;  
                constexpr std::ptrdiff_t m_flEndFadeDot = 0x2AC0;  
                constexpr std::ptrdiff_t m_flRadiusTaper = 0x2AC4;  
                constexpr std::ptrdiff_t m_nMinTesselation = 0x2AC8;  
                constexpr std::ptrdiff_t m_nMaxTesselation = 0x2ACC;  
                constexpr std::ptrdiff_t m_flTessScale = 0x2AD0;  
                constexpr std::ptrdiff_t m_flTextureVWorldSize = 0x2AD8;  
                constexpr std::ptrdiff_t m_flTextureVScrollRate = 0x2C38;  
                constexpr std::ptrdiff_t m_flTextureVOffset = 0x2D98;  
                constexpr std::ptrdiff_t m_nTextureVParamsCP = 0x2EF8;  
                constexpr std::ptrdiff_t m_bClampV = 0x2EFC;  
                constexpr std::ptrdiff_t m_nScaleCP1 = 0x2F00;  
                constexpr std::ptrdiff_t m_nScaleCP2 = 0x2F04;  
                constexpr std::ptrdiff_t m_flScaleVSizeByControlPointDistance = 0x2F08;  
                constexpr std::ptrdiff_t m_flScaleVScrollByControlPointDistance = 0x2F0C;  
                constexpr std::ptrdiff_t m_flScaleVOffsetByControlPointDistance = 0x2F10;  
                constexpr std::ptrdiff_t m_bUseScalarForTextureCoordinate = 0x2F15;  
                constexpr std::ptrdiff_t m_nScalarFieldForTextureCoordinate = 0x2F18;  
                constexpr std::ptrdiff_t m_flScalarAttributeTextureCoordScale = 0x2F1C;  
                constexpr std::ptrdiff_t m_bReverseOrder = 0x2F20;  
                constexpr std::ptrdiff_t m_bClosedLoop = 0x2F21;  
                constexpr std::ptrdiff_t m_nOrientationType = 0x2F24;  
                constexpr std::ptrdiff_t m_nVectorFieldForOrientation = 0x2F28;  
                constexpr std::ptrdiff_t m_bDrawAsOpaque = 0x2F2C;  
                constexpr std::ptrdiff_t m_bGenerateNormals = 0x2F2D;  
            }
            namespace C_INIT_StatusEffectCitadel {
                constexpr std::ptrdiff_t m_flSFXColorWarpAmount = 0x1C8;  
                constexpr std::ptrdiff_t m_flSFXNormalAmount = 0x1CC;  
                constexpr std::ptrdiff_t m_flSFXMetalnessAmount = 0x1D0;  
                constexpr std::ptrdiff_t m_flSFXRoughnessAmount = 0x1D4;  
                constexpr std::ptrdiff_t m_flSFXSelfIllumAmount = 0x1D8;  
                constexpr std::ptrdiff_t m_flSFXSScale = 0x1DC;  
                constexpr std::ptrdiff_t m_flSFXSScrollX = 0x1E0;  
                constexpr std::ptrdiff_t m_flSFXSScrollY = 0x1E4;  
                constexpr std::ptrdiff_t m_flSFXSScrollZ = 0x1E8;  
                constexpr std::ptrdiff_t m_flSFXSOffsetX = 0x1EC;  
                constexpr std::ptrdiff_t m_flSFXSOffsetY = 0x1F0;  
                constexpr std::ptrdiff_t m_flSFXSOffsetZ = 0x1F4;  
                constexpr std::ptrdiff_t m_nDetailCombo = 0x1F8;  
                constexpr std::ptrdiff_t m_flSFXSDetailAmount = 0x1FC;  
                constexpr std::ptrdiff_t m_flSFXSDetailScale = 0x200;  
                constexpr std::ptrdiff_t m_flSFXSDetailScrollX = 0x204;  
                constexpr std::ptrdiff_t m_flSFXSDetailScrollY = 0x208;  
                constexpr std::ptrdiff_t m_flSFXSDetailScrollZ = 0x20C;  
                constexpr std::ptrdiff_t m_flSFXSUseModelUVs = 0x210;  
            }
            namespace C_OP_RenderSound {
                constexpr std::ptrdiff_t m_flDurationScale = 0x210;  
                constexpr std::ptrdiff_t m_flSndLvlScale = 0x214;  
                constexpr std::ptrdiff_t m_flPitchScale = 0x218;  
                constexpr std::ptrdiff_t m_flVolumeScale = 0x21C;  
                constexpr std::ptrdiff_t m_nSndLvlField = 0x220;  
                constexpr std::ptrdiff_t m_nDurationField = 0x224;  
                constexpr std::ptrdiff_t m_nPitchField = 0x228;  
                constexpr std::ptrdiff_t m_nVolumeField = 0x22C;  
                constexpr std::ptrdiff_t m_nChannel = 0x230;  
                constexpr std::ptrdiff_t m_nCPReference = 0x234;  
                constexpr std::ptrdiff_t m_pszSoundName = 0x238;  
                constexpr std::ptrdiff_t m_bSuppressStopSoundEvent = 0x338;  
            }
            ...
            namespace C_OP_RemapSDFDistanceToVectorAttribute {
                ...
                constexpr std::ptrdiff_t m_flMaxDistance = 0x328;  
                constexpr std::ptrdiff_t m_vValueBelowMin = 0x488;  
                constexpr std::ptrdiff_t m_vValueAtMin = 0x494;  
                constexpr std::ptrdiff_t m_vValueAtMax = 0x4A0;  
                constexpr std::ptrdiff_t m_vValueAboveMax = 0x4AC;  
            }
            ...
            namespace C_INIT_StatusEffect {
                ...
                constexpr std::ptrdiff_t m_flDetail2Rotation = 0x1CC;  
                constexpr std::ptrdiff_t m_flDetail2Scale = 0x1D0;  
                constexpr std::ptrdiff_t m_flDetail2BlendFactor = 0x1D4;  
                constexpr std::ptrdiff_t m_flColorWarpIntensity = 0x1D8;  
                constexpr std::ptrdiff_t m_flDiffuseWarpBlendToFull = 0x1DC;  
                constexpr std::ptrdiff_t m_flEnvMapIntensity = 0x1E0;  
                constexpr std::ptrdiff_t m_flAmbientScale = 0x1E4;  
                constexpr std::ptrdiff_t m_specularColor = 0x1E8;  
                constexpr std::ptrdiff_t m_flSpecularScale = 0x1EC;  
                constexpr std::ptrdiff_t m_flSpecularExponent = 0x1F0;  
                constexpr std::ptrdiff_t m_flSpecularExponentBlendToFull = 0x1F4;  
                constexpr std::ptrdiff_t m_flSpecularBlendToFull = 0x1F8;  
                constexpr std::ptrdiff_t m_rimLightColor = 0x1FC;  
                constexpr std::ptrdiff_t m_flRimLightScale = 0x200;  
                constexpr std::ptrdiff_t m_flReflectionsTintByBaseBlendToNone = 0x204;  
                constexpr std::ptrdiff_t m_flMetalnessBlendToFull = 0x208;  
                constexpr std::ptrdiff_t m_flSelfIllumBlendToFull = 0x20C;  
            }
            namespace C_INIT_RtEnvCull {
                constexpr std::ptrdiff_t m_vecTestDir = 0x1C8;  
                constexpr std::ptrdiff_t m_vecTestNormal = 0x1D4;  
                constexpr std::ptrdiff_t m_bUseVelocity = 0x1E0;  
                constexpr std::ptrdiff_t m_bCullOnMiss = 0x1E1;  
                constexpr std::ptrdiff_t m_bLifeAdjust = 0x1E2;  
                constexpr std::ptrdiff_t m_RtEnvName = 0x1E3;  
                constexpr std::ptrdiff_t m_nRTEnvCP = 0x264;  
                constexpr std::ptrdiff_t m_nComponent = 0x268;  
            }
            namespace C_OP_ConstrainDistance {
                constexpr std::ptrdiff_t m_fMinDistance = 0x1C0;  
                constexpr std::ptrdiff_t m_fMaxDistance = 0x320;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x480;  
                constexpr std::ptrdiff_t m_CenterOffset = 0x484;  
                constexpr std::ptrdiff_t m_bGlobalCenter = 0x490;  
            }
            namespace C_INIT_RandomVector {
                constexpr std::ptrdiff_t m_vecMin = 0x1C8;  
                constexpr std::ptrdiff_t m_vecMax = 0x1D4;  
            ...
            namespace C_INIT_InitialVelocityNoise {
                constexpr std::ptrdiff_t m_vecAbsVal = 0x1C8;  
                constexpr std::ptrdiff_t m_vecAbsValInv = 0x1D4;  
                constexpr std::ptrdiff_t m_vecOffsetLoc = 0x1E0;  
                constexpr std::ptrdiff_t m_flOffset = 0x858;  
                constexpr std::ptrdiff_t m_vecOutputMin = 0x9B8;  
                constexpr std::ptrdiff_t m_vecOutputMax = 0x1030;  
                constexpr std::ptrdiff_t m_flNoiseScale = 0x16A8;  
                constexpr std::ptrdiff_t m_flNoiseScaleLoc = 0x1808;  
                constexpr std::ptrdiff_t m_TransformInput = 0x1968;  
                constexpr std::ptrdiff_t m_bIgnoreDt = 0x19D0;  
            }
            ...
            namespace C_INIT_VelocityRandom {
                ...
                constexpr std::ptrdiff_t m_fSpeedMin = 0x1D0;  
                constexpr std::ptrdiff_t m_fSpeedMax = 0x330;  
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMin = 0x490;  
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMax = 0xB08;  
                constexpr std::ptrdiff_t m_bIgnoreDT = 0x1180;  
            ...
            namespace C_OP_ModelDampenMovement {
                ...
                constexpr std::ptrdiff_t m_fDrag = 0x8C0;  
            }
            ...
            namespace C_OP_RemapExternalWindToCP {
                ...
                constexpr std::ptrdiff_t m_nCPOutput = 0x1CC;  
                constexpr std::ptrdiff_t m_vecScale = 0x1D0;  
                constexpr std::ptrdiff_t m_bSetMagnitude = 0x848;  
                constexpr std::ptrdiff_t m_nOutVectorField = 0x84C;  
            }
            namespace CBaseRendererSource2 {
                constexpr std::ptrdiff_t m_flRadiusScale = 0x210;  
                constexpr std::ptrdiff_t m_flAlphaScale = 0x370;  
                constexpr std::ptrdiff_t m_flRollScale = 0x4D0;  
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x630;  
                constexpr std::ptrdiff_t m_vecColorScale = 0x638;  
                constexpr std::ptrdiff_t m_nColorBlendType = 0xCB0;  
                constexpr std::ptrdiff_t m_nShaderType = 0xCB4;  
                constexpr std::ptrdiff_t m_strShaderOverride = 0xCB8;  
                constexpr std::ptrdiff_t m_flCenterXOffset = 0xCC0;  
                constexpr std::ptrdiff_t m_flCenterYOffset = 0xE20;  
                constexpr std::ptrdiff_t m_flBumpStrength = 0xF80;  
                constexpr std::ptrdiff_t m_nCropTextureOverride = 0xF84;  
                constexpr std::ptrdiff_t m_vecTexturesInput = 0xF88;  
                constexpr std::ptrdiff_t m_flAnimationRate = 0xFA0;  
                constexpr std::ptrdiff_t m_nAnimationType = 0xFA4;  
                constexpr std::ptrdiff_t m_bAnimateInFPS = 0xFA8;  
                constexpr std::ptrdiff_t m_flMotionVectorScaleU = 0xFB0;  
                constexpr std::ptrdiff_t m_flMotionVectorScaleV = 0x1110;  
                constexpr std::ptrdiff_t m_flSelfIllumAmount = 0x1270;  
                constexpr std::ptrdiff_t m_flDiffuseAmount = 0x13D0;  
                constexpr std::ptrdiff_t m_flDiffuseClamp = 0x1530;  
                constexpr std::ptrdiff_t m_nLightingControlPoint = 0x1690;  
                constexpr std::ptrdiff_t m_nSelfIllumPerParticle = 0x1694;  
                constexpr std::ptrdiff_t m_nOutputBlendMode = 0x1698;  
                constexpr std::ptrdiff_t m_bGammaCorrectVertexColors = 0x169C;  
                constexpr std::ptrdiff_t m_bSaturateColorPreAlphaBlend = 0x169D;  
                constexpr std::ptrdiff_t m_flAddSelfAmount = 0x16A0;  
                constexpr std::ptrdiff_t m_flDesaturation = 0x1800;  
                constexpr std::ptrdiff_t m_flOverbrightFactor = 0x1960;  
                constexpr std::ptrdiff_t m_nHSVShiftControlPoint = 0x1AC0;  
                constexpr std::ptrdiff_t m_nFogType = 0x1AC4;  
                constexpr std::ptrdiff_t m_flFogAmount = 0x1AC8;  
                constexpr std::ptrdiff_t m_bTintByFOW = 0x1C28;  
                constexpr std::ptrdiff_t m_bTintByGlobalLight = 0x1C29;  
                ...
                constexpr std::ptrdiff_t m_flAlphaReferenceSoftness = 0x1C38;  
                constexpr std::ptrdiff_t m_flSourceAlphaValueToMapToZero = 0x1D98;  
                constexpr std::ptrdiff_t m_flSourceAlphaValueToMapToOne = 0x1EF8;  
                constexpr std::ptrdiff_t m_bRefract = 0x2058;  
                constexpr std::ptrdiff_t m_bRefractSolid = 0x2059;  
                constexpr std::ptrdiff_t m_flRefractAmount = 0x2060;  
                ...
                constexpr std::ptrdiff_t m_bOnlyRenderInEffecsGameOverlay = 0x21CB;  
                constexpr std::ptrdiff_t m_stencilTestID = 0x21CC;  
                constexpr std::ptrdiff_t m_bStencilTestExclude = 0x224C;  
                constexpr std::ptrdiff_t m_stencilWriteID = 0x224D;  
                constexpr std::ptrdiff_t m_bWriteStencilOnDepthPass = 0x22CD;  
                constexpr std::ptrdiff_t m_bWriteStencilOnDepthFail = 0x22CE;  
                constexpr std::ptrdiff_t m_bReverseZBuffering = 0x22CF;  
                constexpr std::ptrdiff_t m_bDisableZBuffering = 0x22D0;  
                constexpr std::ptrdiff_t m_nFeatheringMode = 0x22D4;  
                constexpr std::ptrdiff_t m_flFeatheringMinDist = 0x22D8;  
                constexpr std::ptrdiff_t m_flFeatheringMaxDist = 0x2438;  
                constexpr std::ptrdiff_t m_flFeatheringFilter = 0x2598;  
                constexpr std::ptrdiff_t m_flDepthBias = 0x26F8;  
                constexpr std::ptrdiff_t m_nSortMethod = 0x2858;  
                constexpr std::ptrdiff_t m_bBlendFramesSeq0 = 0x285C;  
                constexpr std::ptrdiff_t m_bMaxLuminanceBlendingSequence0 = 0x285D;  
            }
            ...
            namespace C_OP_RemapDotProductToCP {
                constexpr std::ptrdiff_t m_nInputCP1 = 0x1C8;  
                constexpr std::ptrdiff_t m_nInputCP2 = 0x1CC;  
                constexpr std::ptrdiff_t m_nOutputCP = 0x1D0;  
                ...
                constexpr std::ptrdiff_t m_flOutputMin = 0x498;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x5F8;  
            }
            namespace C_INIT_RemapParticleCountToNamedModelElementScalar {
                constexpr std::ptrdiff_t m_hModel = 0x1F8;  
                constexpr std::ptrdiff_t m_outputMinName = 0x200;  
                constexpr std::ptrdiff_t m_outputMaxName = 0x208;  
                constexpr std::ptrdiff_t m_bModelFromRenderer = 0x210;  
            }
            namespace C_OP_RenderTrails {
                constexpr std::ptrdiff_t m_bEnableFadingAndClamping = 0x2D80;  
                constexpr std::ptrdiff_t m_flStartFadeDot = 0x2D84;  
                constexpr std::ptrdiff_t m_flEndFadeDot = 0x2D88;  
                constexpr std::ptrdiff_t m_nPrevPntSource = 0x2D8C;  
                constexpr std::ptrdiff_t m_flMaxLength = 0x2D90;  
                constexpr std::ptrdiff_t m_flMinLength = 0x2D94;  
                constexpr std::ptrdiff_t m_bIgnoreDT = 0x2D98;  
                constexpr std::ptrdiff_t m_flConstrainRadiusToLengthRatio = 0x2D9C;  
                constexpr std::ptrdiff_t m_flLengthScale = 0x2DA0;  
                constexpr std::ptrdiff_t m_flLengthFadeInTime = 0x2DA4;  
                constexpr std::ptrdiff_t m_flRadiusHeadTaper = 0x2DA8;  
                constexpr std::ptrdiff_t m_vecHeadColorScale = 0x2F08;  
                constexpr std::ptrdiff_t m_flHeadAlphaScale = 0x3580;  
                constexpr std::ptrdiff_t m_flRadiusTaper = 0x36E0;  
                constexpr std::ptrdiff_t m_vecTailColorScale = 0x3840;  
                constexpr std::ptrdiff_t m_flTailAlphaScale = 0x3EB8;  
                constexpr std::ptrdiff_t m_nHorizCropField = 0x4018;  
                constexpr std::ptrdiff_t m_nVertCropField = 0x401C;  
                constexpr std::ptrdiff_t m_flForwardShift = 0x4020;  
                constexpr std::ptrdiff_t m_bFlipUVBasedOnPitchYaw = 0x4024;  
            }
            namespace C_OP_SetControlPointPositionToTimeOfDayValue {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_pszTimeOfDayParameter = 0x1CC;  
                constexpr std::ptrdiff_t m_vecDefaultValue = 0x24C;  
            }
            namespace C_OP_DecayMaintainCount {
                ...
                constexpr std::ptrdiff_t m_bKillNewest = 0x330;  
            }
            namespace C_INIT_RandomModelSequence {
                constexpr std::ptrdiff_t m_ActivityName = 0x1C8;  
                constexpr std::ptrdiff_t m_SequenceName = 0x2C8;  
            ...
            namespace C_OP_ExternalGameImpulseForce {
                ...
                constexpr std::ptrdiff_t m_bRopes = 0x330;  
                constexpr std::ptrdiff_t m_bRopesZOnly = 0x331;  
                constexpr std::ptrdiff_t m_bExplosions = 0x332;  
                constexpr std::ptrdiff_t m_bParticles = 0x333;  
            }
            namespace C_OP_RemapAverageHitboxSpeedtoCP {
                ...
                constexpr std::ptrdiff_t m_flOutputMin = 0x498;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x5F8;  
                constexpr std::ptrdiff_t m_nHeightControlPointNumber = 0x758;  
                constexpr std::ptrdiff_t m_vecComparisonVelocity = 0x760;  
                constexpr std::ptrdiff_t m_HitboxSetName = 0xDD8;  
            }
            namespace C_INIT_RandomAlpha {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_nAlphaMin = 0x1CC;  
                constexpr std::ptrdiff_t m_nAlphaMax = 0x1D0;  
                constexpr std::ptrdiff_t m_flAlphaRandExponent = 0x1DC;  
            }
            ...
            namespace C_OP_RepeatedTriggerChildGroup {
                ...
                constexpr std::ptrdiff_t m_flClusterRefireTime = 0x1D0;  
                constexpr std::ptrdiff_t m_flClusterSize = 0x330;  
                constexpr std::ptrdiff_t m_flClusterCooldown = 0x490;  
                constexpr std::ptrdiff_t m_bLimitChildCount = 0x5F0;  
            }
            namespace C_OP_RenderTonemapController {
                constexpr std::ptrdiff_t m_flTonemapLevel = 0x210;  
                constexpr std::ptrdiff_t m_flTonemapWeight = 0x214;  
                constexpr std::ptrdiff_t m_nTonemapLevelField = 0x218;  
                constexpr std::ptrdiff_t m_nTonemapWeightField = 0x21C;  
            }
            ...
            namespace C_INIT_SetHitboxToClosest {
                ...
                constexpr std::ptrdiff_t m_bUseBones = 0x8C8;  
                constexpr std::ptrdiff_t m_bUseClosestPointOnHitbox = 0x8C9;  
                constexpr std::ptrdiff_t m_nTestType = 0x8CC;  
                constexpr std::ptrdiff_t m_flHybridRatio = 0x8D0;  
                constexpr std::ptrdiff_t m_bUpdatePosition = 0xA30;  
            }
            namespace C_INIT_RingWave {
                constexpr std::ptrdiff_t m_TransformInput = 0x1C8;  
                constexpr std::ptrdiff_t m_flParticlesPerOrbit = 0x230;  
                constexpr std::ptrdiff_t m_flInitialRadius = 0x390;  
                constexpr std::ptrdiff_t m_flThickness = 0x4F0;  
                constexpr std::ptrdiff_t m_flInitialSpeedMin = 0x650;  
                constexpr std::ptrdiff_t m_flInitialSpeedMax = 0x7B0;  
                constexpr std::ptrdiff_t m_flRoll = 0x910;  
                constexpr std::ptrdiff_t m_flPitch = 0xA70;  
                constexpr std::ptrdiff_t m_flYaw = 0xBD0;  
                constexpr std::ptrdiff_t m_bEvenDistribution = 0xD30;  
                constexpr std::ptrdiff_t m_bXYVelocityOnly = 0xD31;  
            }
            namespace C_INIT_RandomTrailLength {
                constexpr std::ptrdiff_t m_flMinLength = 0x1C8;  
                constexpr std::ptrdiff_t m_flMaxLength = 0x1CC;  
                constexpr std::ptrdiff_t m_flLengthRandExponent = 0x1D0;  
            }
            ...
            namespace C_OP_DistanceBetweenTransforms {
                ...
                constexpr std::ptrdiff_t m_flInputMax = 0x3F8;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x558;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x6B8;  
                ...
                constexpr std::ptrdiff_t m_nTraceSet = 0x8A0;  
                constexpr std::ptrdiff_t m_bLOS = 0x8A4;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x8A8;  
            }
            namespace C_OP_DecayOffscreen {
                constexpr std::ptrdiff_t m_flOffscreenTime = 0x1C0;  
            }
            namespace C_INIT_CreateSequentialPath {
                constexpr std::ptrdiff_t m_fMaxDistance = 0x1C8;  
                constexpr std::ptrdiff_t m_flNumToAssign = 0x1CC;  
                constexpr std::ptrdiff_t m_bLoop = 0x1D0;  
                constexpr std::ptrdiff_t m_bCPPairs = 0x1D1;  
                constexpr std::ptrdiff_t m_bSaveOffset = 0x1D2;  
            ...
            namespace C_OP_ContinuousEmitter {
                constexpr std::ptrdiff_t m_flEmissionDuration = 0x1C8;  
                constexpr std::ptrdiff_t m_flStartTime = 0x328;  
                constexpr std::ptrdiff_t m_flEmitRate = 0x488;  
                constexpr std::ptrdiff_t m_flEmissionScale = 0x5E8;  
                constexpr std::ptrdiff_t m_flScalePerParentParticle = 0x5EC;  
                constexpr std::ptrdiff_t m_bInitFromKilledParentParticles = 0x5F0;  
                constexpr std::ptrdiff_t m_nEventType = 0x5F4;  
                constexpr std::ptrdiff_t m_nSnapshotControlPoint = 0x5F8;  
                constexpr std::ptrdiff_t m_nLimitPerUpdate = 0x5FC;  
                constexpr std::ptrdiff_t m_bForceEmitOnFirstUpdate = 0x600;  
                constexpr std::ptrdiff_t m_bForceEmitOnLastUpdate = 0x601;  
            }
            ...
            namespace C_INIT_SequenceLifeTime {
                constexpr std::ptrdiff_t m_flFramerate = 0x1C8;  
            }
            namespace C_INIT_MoveBetweenPoints {
                constexpr std::ptrdiff_t m_flSpeedMin = 0x1C8;  
                constexpr std::ptrdiff_t m_flSpeedMax = 0x328;  
                constexpr std::ptrdiff_t m_flEndSpread = 0x488;  
                constexpr std::ptrdiff_t m_flStartOffset = 0x5E8;  
                constexpr std::ptrdiff_t m_flEndOffset = 0x748;  
                constexpr std::ptrdiff_t m_nEndControlPointNumber = 0x8A8;  
                constexpr std::ptrdiff_t m_bTrailBias = 0x8AC;  
            }
            namespace C_INIT_RemapScalar {
                constexpr std::ptrdiff_t m_nFieldInput = 0x1C8;  
                ...
                constexpr std::ptrdiff_t m_flStartTime = 0x1E0;  
                constexpr std::ptrdiff_t m_flEndTime = 0x1E4;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x1E8;  
                constexpr std::ptrdiff_t m_bActiveRange = 0x1EC;  
                constexpr std::ptrdiff_t m_flRemapBias = 0x1F0;  
            }
            namespace C_OP_SetUserEvent {
                constexpr std::ptrdiff_t m_flInput = 0x1C0;  
                constexpr std::ptrdiff_t m_flRisingEdge = 0x320;  
                constexpr std::ptrdiff_t m_nRisingEventType = 0x480;  
                constexpr std::ptrdiff_t m_flFallingEdge = 0x488;  
            ...
            namespace C_OP_BasicMovement {
                ...
                constexpr std::ptrdiff_t m_fDrag = 0x838;  
                constexpr std::ptrdiff_t m_massControls = 0x998;  
                constexpr std::ptrdiff_t m_nMaxConstraintPasses = 0xDC0;  
                constexpr std::ptrdiff_t m_bUseNewCode = 0xDC4;  
            }
            namespace C_INIT_RandomNamedModelElement {
                constexpr std::ptrdiff_t m_hModel = 0x1C8;  
                constexpr std::ptrdiff_t m_names = 0x1D0;  
                constexpr std::ptrdiff_t m_bShuffle = 0x1E8;  
                constexpr std::ptrdiff_t m_bLinear = 0x1E9;  
                constexpr std::ptrdiff_t m_bModelFromRenderer = 0x1EA;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1EC;  
            }
            namespace C_INIT_InitFromParentKilled {
                constexpr std::ptrdiff_t m_nAttributeToCopy = 0x1C8;  
            ...
            namespace CParticleFunction {
                ...
                constexpr std::ptrdiff_t m_flOpStartFadeInTime = 0x16C;  
                constexpr std::ptrdiff_t m_flOpEndFadeInTime = 0x170;  
                constexpr std::ptrdiff_t m_flOpStartFadeOutTime = 0x174;  
                constexpr std::ptrdiff_t m_flOpEndFadeOutTime = 0x178;  
                constexpr std::ptrdiff_t m_flOpFadeOscillatePeriod = 0x17C;  
                constexpr std::ptrdiff_t m_bNormalizeToStopTime = 0x180;  
                constexpr std::ptrdiff_t m_flOpTimeOffsetMin = 0x184;  
                constexpr std::ptrdiff_t m_flOpTimeOffsetMax = 0x188;  
                constexpr std::ptrdiff_t m_nOpTimeOffsetSeed = 0x18C;  
                constexpr std::ptrdiff_t m_nOpTimeScaleSeed = 0x190;  
                constexpr std::ptrdiff_t m_flOpTimeScaleMin = 0x194;  
                constexpr std::ptrdiff_t m_flOpTimeScaleMax = 0x198;  
                constexpr std::ptrdiff_t m_bDisableOperator = 0x19E;  
                constexpr std::ptrdiff_t m_Notes = 0x1A0;  
            }
            ...
            namespace C_OP_SetParentControlPointsToChildCP {
                constexpr std::ptrdiff_t m_nChildGroupID = 0x1C8;  
                constexpr std::ptrdiff_t m_nChildControlPoint = 0x1CC;  
                constexpr std::ptrdiff_t m_nNumControlPoints = 0x1D0;  
                constexpr std::ptrdiff_t m_nFirstSourcePoint = 0x1D4;  
                constexpr std::ptrdiff_t m_bSetOrientation = 0x1D8;  
            }
            ...
            namespace C_OP_BoxConstraint {
                ...
                constexpr std::ptrdiff_t m_vecMax = 0x838;  
                constexpr std::ptrdiff_t m_nCP = 0xEB0;  
                constexpr std::ptrdiff_t m_bLocalSpace = 0xEB4;  
                constexpr std::ptrdiff_t m_bAccountForRadius = 0xEB5;  
            }
            namespace C_INIT_CreatePhyllotaxis {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nScaleCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nComponent = 0x1D0;  
                constexpr std::ptrdiff_t m_fRadCentCore = 0x1D4;  
                constexpr std::ptrdiff_t m_fRadPerPoint = 0x1D8;  
                constexpr std::ptrdiff_t m_fRadPerPointTo = 0x1DC;  
                constexpr std::ptrdiff_t m_fpointAngle = 0x1E0;  
                constexpr std::ptrdiff_t m_fsizeOverall = 0x1E4;  
                constexpr std::ptrdiff_t m_fRadBias = 0x1E8;  
                constexpr std::ptrdiff_t m_fMinRad = 0x1EC;  
                constexpr std::ptrdiff_t m_fDistBias = 0x1F0;  
                constexpr std::ptrdiff_t m_bUseLocalCoords = 0x1F4;  
                constexpr std::ptrdiff_t m_bUseWithContEmit = 0x1F5;  
                constexpr std::ptrdiff_t m_bUseOrigRadius = 0x1F6;  
            }
            namespace C_OP_AttractToControlPoint {
                ...
                constexpr std::ptrdiff_t m_fFalloffPower = 0x340;  
                constexpr std::ptrdiff_t m_TransformInput = 0x348;  
                constexpr std::ptrdiff_t m_fForceAmountMin = 0x3B0;  
                constexpr std::ptrdiff_t m_bApplyMinForce = 0x510;  
            }
            namespace C_INIT_RandomLifeTime {
                constexpr std::ptrdiff_t m_fLifetimeMin = 0x1C8;  
                constexpr std::ptrdiff_t m_fLifetimeMax = 0x1CC;  
                constexpr std::ptrdiff_t m_fLifetimeRandExponent = 0x1D0;  
            }
            ...
            namespace C_INIT_VelocityRadialRandom {
                ...
                constexpr std::ptrdiff_t m_fSpeedMin = 0x1D0;  
                constexpr std::ptrdiff_t m_fSpeedMax = 0x330;  
                constexpr std::ptrdiff_t m_vecLocalCoordinateSystemSpeedScale = 0x490;  
                constexpr std::ptrdiff_t m_bIgnoreDelta = 0x49D;  
            }
            namespace C_INIT_RandomRadius {
                constexpr std::ptrdiff_t m_flRadiusMin = 0x1C8;  
                constexpr std::ptrdiff_t m_flRadiusMax = 0x1CC;  
                constexpr std::ptrdiff_t m_flRadiusRandExponent = 0x1D0;  
            }
            ...
            namespace TextureControls_t {
                ...
                constexpr std::ptrdiff_t m_flFinalTextureScaleV = 0x160;  
                constexpr std::ptrdiff_t m_flFinalTextureOffsetU = 0x2C0;  
                constexpr std::ptrdiff_t m_flFinalTextureOffsetV = 0x420;  
                constexpr std::ptrdiff_t m_flFinalTextureUVRotation = 0x580;  
                constexpr std::ptrdiff_t m_flZoomScale = 0x6E0;  
                constexpr std::ptrdiff_t m_flDistortion = 0x840;  
                constexpr std::ptrdiff_t m_bRandomizeOffsets = 0x9A0;  
                constexpr std::ptrdiff_t m_bClampUVs = 0x9A1;  
            ...
            namespace C_OP_SetControlPointToVectorExpression {
                ...
                constexpr std::ptrdiff_t m_nOutputCP = 0x1CC;  
                constexpr std::ptrdiff_t m_vInput1 = 0x1D0;  
                constexpr std::ptrdiff_t m_vInput2 = 0x848;  
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0xEC0;  
            }
            namespace C_OP_LightningSnapshotGenerator {
                constexpr std::ptrdiff_t m_nCPSnapshot = 0x1C8;  
                constexpr std::ptrdiff_t m_nCPStartPnt = 0x1CC;  
                constexpr std::ptrdiff_t m_nCPEndPnt = 0x1D0;  
                constexpr std::ptrdiff_t m_flSegments = 0x1D8;  
                constexpr std::ptrdiff_t m_flOffset = 0x338;  
                constexpr std::ptrdiff_t m_flOffsetDecay = 0x498;  
                constexpr std::ptrdiff_t m_flRecalcRate = 0x5F8;  
                constexpr std::ptrdiff_t m_flUVScale = 0x758;  
            ...
            namespace C_INIT_RemapSpeedToScalar {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1CC;  
                ...
                constexpr std::ptrdiff_t m_nSetMethod = 0x1E8;  
                constexpr std::ptrdiff_t m_bPerParticle = 0x1EC;  
            }
            namespace C_INIT_RemapQAnglesToRotation {
                constexpr std::ptrdiff_t m_TransformInput = 0x1C8;  
            }
            namespace C_INIT_PositionWarp {
                constexpr std::ptrdiff_t m_vecWarpMin = 0x1C8;  
                constexpr std::ptrdiff_t m_vecWarpMax = 0x840;  
                constexpr std::ptrdiff_t m_nScaleControlPointNumber = 0xEB8;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xEBC;  
                constexpr std::ptrdiff_t m_nRadiusComponent = 0xEC0;  
                constexpr std::ptrdiff_t m_flWarpTime = 0xEC4;  
                constexpr std::ptrdiff_t m_flWarpStartTime = 0xEC8;  
                constexpr std::ptrdiff_t m_flPrevPosScale = 0xECC;  
                constexpr std::ptrdiff_t m_bInvertWarp = 0xED0;  
                constexpr std::ptrdiff_t m_bUseCount = 0xED1;  
            }
            namespace C_OP_SDFConstraint {
                constexpr std::ptrdiff_t m_flMinDist = 0x1C0;  
                constexpr std::ptrdiff_t m_flMaxDist = 0x320;  
                constexpr std::ptrdiff_t m_nMaxIterations = 0x480;  
            }
            namespace C_OP_SetControlPointFieldToScalarExpression {
                constexpr std::ptrdiff_t m_nExpression = 0x1C8;  
                constexpr std::ptrdiff_t m_flInput1 = 0x1D0;  
                constexpr std::ptrdiff_t m_flInput2 = 0x330;  
                constexpr std::ptrdiff_t m_flOutputRemap = 0x490;  
                constexpr std::ptrdiff_t m_nOutputCP = 0x5F0;  
                constexpr std::ptrdiff_t m_nOutVectorField = 0x5F4;  
            }
            namespace CParticleFunctionForce {
            }
            namespace C_INIT_RandomVectorComponent {
                constexpr std::ptrdiff_t m_flMin = 0x1C8;  
                constexpr std::ptrdiff_t m_flMax = 0x1CC;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D0;  
                constexpr std::ptrdiff_t m_nComponent = 0x1D4;  
            }
            ...
            namespace C_INIT_SetVectorAttributeToVectorExpression {
                ...
                constexpr std::ptrdiff_t m_vInput1 = 0x1D0;  
                constexpr std::ptrdiff_t m_vInput2 = 0x848;  
                constexpr std::ptrdiff_t m_nOutputField = 0xEC0;  
                constexpr std::ptrdiff_t m_nSetMethod = 0xEC4;  
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0xEC8;  
            }
            ...
            namespace C_OP_DirectionBetweenVecsToVec {
                ...
                constexpr std::ptrdiff_t m_vecPoint2 = 0x840;  
            }
            namespace C_OP_MovementLoopInsideSphere {
                ...
                constexpr std::ptrdiff_t m_nDistSqrAttr = 0x9A0;  
            }
            namespace C_OP_RenderSimpleModelCollection {
                ...
                constexpr std::ptrdiff_t m_bAcceptsDecals = 0x3E2;  
                constexpr std::ptrdiff_t m_nAngularVelocityField = 0x3E4;  
            }
            namespace C_OP_QuantizeCPComponent {
                constexpr std::ptrdiff_t m_flInputValue = 0x1C8;  
            ...
            namespace C_OP_PlayEndCapWhenFinished {
                constexpr std::ptrdiff_t m_bFireOnEmissionEnd = 0x1C8;  
                constexpr std::ptrdiff_t m_bIncludeChildren = 0x1C9;  
            }
            namespace C_INIT_InitFloatCollection {
                constexpr std::ptrdiff_t m_InputValue = 0x1C8;  
                constexpr std::ptrdiff_t m_nOutputField = 0x328;  
            }
            ...
            namespace C_INIT_CreateFromPlaneCache {
                constexpr std::ptrdiff_t m_vecOffsetMin = 0x1C8;  
                constexpr std::ptrdiff_t m_vecOffsetMax = 0x1D4;  
                constexpr std::ptrdiff_t m_bUseNormal = 0x1E1;  
            }
            namespace C_OP_ControlPointToRadialScreenSpace {
                constexpr std::ptrdiff_t m_nCPIn = 0x1C8;  
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1CC;  
                constexpr std::ptrdiff_t m_nCPOut = 0x1D8;  
                constexpr std::ptrdiff_t m_nCPOutField = 0x1DC;  
                constexpr std::ptrdiff_t m_nCPSSPosOut = 0x1E0;  
            }
            namespace C_OP_SpinUpdate {
            }
            namespace C_INIT_NormalOffset {
                constexpr std::ptrdiff_t m_OffsetMin = 0x1C8;  
                constexpr std::ptrdiff_t m_OffsetMax = 0x1D4;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1E0;  
                constexpr std::ptrdiff_t m_bLocalCoords = 0x1E4;  
                constexpr std::ptrdiff_t m_bNormalize = 0x1E5;  
            }
            namespace C_OP_RemapDistanceToLineSegmentToVector {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D8;  
                constexpr std::ptrdiff_t m_vMinOutputValue = 0x1DC;  
                constexpr std::ptrdiff_t m_vMaxOutputValue = 0x1E8;  
            }
            namespace C_OP_RenderAsModels {
                constexpr std::ptrdiff_t m_ModelList = 0x210;  
                constexpr std::ptrdiff_t m_flModelScale = 0x22C;  
                constexpr std::ptrdiff_t m_bFitToModelSize = 0x230;  
                constexpr std::ptrdiff_t m_bNonUniformScaling = 0x231;  
                constexpr std::ptrdiff_t m_nXAxisScalingAttribute = 0x234;  
                constexpr std::ptrdiff_t m_nYAxisScalingAttribute = 0x238;  
                constexpr std::ptrdiff_t m_nZAxisScalingAttribute = 0x23C;  
                constexpr std::ptrdiff_t m_nSizeCullBloat = 0x240;  
            }
            namespace C_INIT_CreationNoise {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_bAbsVal = 0x1CC;  
                constexpr std::ptrdiff_t m_bAbsValInv = 0x1CD;  
                constexpr std::ptrdiff_t m_flOffset = 0x1D0;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1D4;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x1D8;  
                constexpr std::ptrdiff_t m_flNoiseScale = 0x1DC;  
                constexpr std::ptrdiff_t m_flNoiseScaleLoc = 0x1E0;  
                constexpr std::ptrdiff_t m_vecOffsetLoc = 0x1E4;  
                constexpr std::ptrdiff_t m_flWorldTimeScale = 0x1F0;  
            }
            namespace C_OP_Spin {
            }
            ...
            namespace CParticleVecInput {
                ...
                constexpr std::ptrdiff_t m_FloatComponentY = 0x208;  
                constexpr std::ptrdiff_t m_FloatComponentZ = 0x368;  
                constexpr std::ptrdiff_t m_FloatInterp = 0x4C8;  
                constexpr std::ptrdiff_t m_flInterpInput0 = 0x628;  
                constexpr std::ptrdiff_t m_flInterpInput1 = 0x62C;  
                constexpr std::ptrdiff_t m_vInterpOutput0 = 0x630;  
                constexpr std::ptrdiff_t m_vInterpOutput1 = 0x63C;  
                constexpr std::ptrdiff_t m_Gradient = 0x648;  
                constexpr std::ptrdiff_t m_vRandomMin = 0x660;  
                constexpr std::ptrdiff_t m_vRandomMax = 0x66C;  
            }
            namespace C_OP_InstantaneousEmitter {
                constexpr std::ptrdiff_t m_nParticlesToEmit = 0x1C8;  
                constexpr std::ptrdiff_t m_flStartTime = 0x328;  
                constexpr std::ptrdiff_t m_flInitFromKilledParentParticles = 0x488;  
                constexpr std::ptrdiff_t m_nEventType = 0x48C;  
                constexpr std::ptrdiff_t m_flParentParticleScale = 0x490;  
                constexpr std::ptrdiff_t m_nMaxEmittedPerFrame = 0x5F0;  
                constexpr std::ptrdiff_t m_nSnapshotControlPoint = 0x5F4;  
            }
            ...
            namespace C_INIT_LifespanFromVelocity {
                ...
                constexpr std::ptrdiff_t m_flTraceOffset = 0x1D4;  
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x1D8;  
                constexpr std::ptrdiff_t m_flTraceTolerance = 0x1DC;  
                constexpr std::ptrdiff_t m_nMaxPlanes = 0x1E0;  
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x1E8;  
                constexpr std::ptrdiff_t m_nTraceSet = 0x268;  
                constexpr std::ptrdiff_t m_bIncludeWater = 0x278;  
            }
            namespace CBaseTrailRenderer {
                constexpr std::ptrdiff_t m_nOrientationType = 0x2AA8;  
                constexpr std::ptrdiff_t m_nOrientationControlPoint = 0x2AAC;  
                constexpr std::ptrdiff_t m_flMinSize = 0x2AB0;  
                constexpr std::ptrdiff_t m_flMaxSize = 0x2AB4;  
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x2AB8;  
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x2C18;  
                constexpr std::ptrdiff_t m_bClampV = 0x2D78;  
            }
            namespace C_INIT_VelocityFromCP {
                constexpr std::ptrdiff_t m_velocityInput = 0x1C8;  
                constexpr std::ptrdiff_t m_transformInput = 0x840;  
                constexpr std::ptrdiff_t m_flVelocityScale = 0x8A8;  
                constexpr std::ptrdiff_t m_bDirectionOnly = 0x8AC;  
            }
            namespace C_OP_SetControlPointOrientation {
                constexpr std::ptrdiff_t m_bUseWorldLocation = 0x1C8;  
                constexpr std::ptrdiff_t m_bRandomize = 0x1CA;  
                constexpr std::ptrdiff_t m_bSetOnce = 0x1CB;  
                constexpr std::ptrdiff_t m_nCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nHeadLocation = 0x1D0;  
                constexpr std::ptrdiff_t m_vecRotation = 0x1D4;  
                constexpr std::ptrdiff_t m_vecRotationB = 0x1E0;  
                constexpr std::ptrdiff_t m_flInterpolation = 0x1F0;  
            }
            namespace C_OP_MovementSkinnedPositionFromCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_flReadIndex = 0x1D8;  
                constexpr std::ptrdiff_t m_flIncrement = 0x338;  
                constexpr std::ptrdiff_t m_nFullLoopIncrement = 0x498;  
                constexpr std::ptrdiff_t m_nSnapShotStartPoint = 0x5F8;  
                constexpr std::ptrdiff_t m_flInterpolation = 0x758;  
            }
            namespace C_OP_OscillateVector {
                ...
                constexpr std::ptrdiff_t m_flOscAdd = 0x368;  
                constexpr std::ptrdiff_t m_flRateScale = 0x4C8;  
            }
            namespace C_OP_PositionLock {
                ...
                constexpr std::ptrdiff_t m_flJumpThreshold = 0x3A8;  
                constexpr std::ptrdiff_t m_flPrevPosScale = 0x3AC;  
                constexpr std::ptrdiff_t m_bLockRot = 0x3B0;  
                constexpr std::ptrdiff_t m_vecScale = 0x3B8;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0xA30;  
                constexpr std::ptrdiff_t m_nFieldOutputPrev = 0xA34;  
            }
            namespace C_OP_RenderVRHapticEvent {
                constexpr std::ptrdiff_t m_nHand = 0x210;  
                constexpr std::ptrdiff_t m_nOutputHandCP = 0x214;  
                constexpr std::ptrdiff_t m_nOutputField = 0x218;  
                constexpr std::ptrdiff_t m_flAmplitude = 0x220;  
            }
            namespace C_OP_SetControlPointToImpactPoint {
                constexpr std::ptrdiff_t m_nCPOut = 0x1C8;  
                constexpr std::ptrdiff_t m_nCPIn = 0x1CC;  
                constexpr std::ptrdiff_t m_flUpdateRate = 0x1D0;  
                constexpr std::ptrdiff_t m_flTraceLength = 0x1D8;  
            ...
            namespace C_OP_SetControlPointToPlayer {
                ...
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1CC;  
                constexpr std::ptrdiff_t m_bOrientToEyes = 0x1D8;  
            }
            namespace C_OP_EndCapTimedFreeze {
                constexpr std::ptrdiff_t m_flFreezeTime = 0x1C0;  
            }
            namespace C_OP_RenderGpuImplicit {
                constexpr std::ptrdiff_t m_bUsePerParticleRadius = 0x210;  
                constexpr std::ptrdiff_t m_nVertexCountKb = 0x214;  
                constexpr std::ptrdiff_t m_nIndexCountKb = 0x218;  
                constexpr std::ptrdiff_t m_fGridSize = 0x220;  
                constexpr std::ptrdiff_t m_fRadiusScale = 0x380;  
                constexpr std::ptrdiff_t m_fIsosurfaceThreshold = 0x4E0;  
                constexpr std::ptrdiff_t m_nScaleCP = 0x640;  
                constexpr std::ptrdiff_t m_hMaterial = 0x648;  
            }
            ...
            namespace C_OP_SetRandomControlPointPosition {
                constexpr std::ptrdiff_t m_bUseWorldLocation = 0x1C8;  
                constexpr std::ptrdiff_t m_bOrient = 0x1C9;  
                constexpr std::ptrdiff_t m_nCP1 = 0x1CC;  
                constexpr std::ptrdiff_t m_nHeadLocation = 0x1D0;  
                constexpr std::ptrdiff_t m_flReRandomRate = 0x1D8;  
            ...
            namespace C_OP_DragRelativeToPlane {
                ...
                constexpr std::ptrdiff_t m_flFalloff = 0x320;  
                constexpr std::ptrdiff_t m_bDirectional = 0x480;  
                constexpr std::ptrdiff_t m_vecPlaneNormal = 0x488;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xB00;  
            }
            ...
            namespace C_OP_SetSingleControlPointPosition {
                constexpr std::ptrdiff_t m_bSetOnce = 0x1C8;  
                constexpr std::ptrdiff_t m_nCP1 = 0x1CC;  
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1D0;  
                constexpr std::ptrdiff_t m_transformInput = 0x848;  
            }
            namespace C_INIT_DistanceToNeighborCull {
                constexpr std::ptrdiff_t m_flDistance = 0x1C8;  
                constexpr std::ptrdiff_t m_bIncludeRadii = 0x328;  
            }
            ...
            namespace CParticleFunctionRenderer {
                ...
                constexpr std::ptrdiff_t m_bCannotBeRefracted = 0x208;  
                constexpr std::ptrdiff_t m_bSkipRenderingOnMobile = 0x209;  
            }
            ...
            namespace C_OP_RenderScreenVelocityRotate {
                constexpr std::ptrdiff_t m_flRotateRateDegrees = 0x210;  
                constexpr std::ptrdiff_t m_flForwardDegrees = 0x214;  
            }
            ...
            namespace C_INIT_CreateWithinBox {
                constexpr std::ptrdiff_t m_vecMin = 0x1C8;  
                constexpr std::ptrdiff_t m_vecMax = 0x840;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xEB8;  
                constexpr std::ptrdiff_t m_bLocalSpace = 0xEBC;  
                constexpr std::ptrdiff_t m_randomnessParameters = 0xEC0;  
            }
            namespace C_OP_ChooseRandomChildrenInGroup {
                constexpr std::ptrdiff_t m_nChildGroupID = 0x1C8;  
                constexpr std::ptrdiff_t m_flNumberOfChildren = 0x1D0;  
            }
            namespace C_OP_ControlpointLight {
                constexpr std::ptrdiff_t m_flScale = 0x1C0;  
                constexpr std::ptrdiff_t m_nControlPoint1 = 0x650;  
                constexpr std::ptrdiff_t m_nControlPoint2 = 0x654;  
                constexpr std::ptrdiff_t m_nControlPoint3 = 0x658;  
                constexpr std::ptrdiff_t m_nControlPoint4 = 0x65C;  
                ...
                constexpr std::ptrdiff_t m_LightFiftyDist1 = 0x690;  
                constexpr std::ptrdiff_t m_LightZeroDist1 = 0x694;  
                constexpr std::ptrdiff_t m_LightFiftyDist2 = 0x698;  
                constexpr std::ptrdiff_t m_LightZeroDist2 = 0x69C;  
                constexpr std::ptrdiff_t m_LightFiftyDist3 = 0x6A0;  
                constexpr std::ptrdiff_t m_LightZeroDist3 = 0x6A4;  
                constexpr std::ptrdiff_t m_LightFiftyDist4 = 0x6A8;  
                constexpr std::ptrdiff_t m_LightZeroDist4 = 0x6AC;  
                constexpr std::ptrdiff_t m_LightColor1 = 0x6B0;  
                constexpr std::ptrdiff_t m_LightColor2 = 0x6B4;  
                constexpr std::ptrdiff_t m_LightColor3 = 0x6B8;  
                constexpr std::ptrdiff_t m_LightColor4 = 0x6BC;  
                constexpr std::ptrdiff_t m_bLightType1 = 0x6C0;  
                constexpr std::ptrdiff_t m_bLightType2 = 0x6C1;  
                constexpr std::ptrdiff_t m_bLightType3 = 0x6C2;  
                constexpr std::ptrdiff_t m_bLightType4 = 0x6C3;  
                constexpr std::ptrdiff_t m_bLightDynamic1 = 0x6C4;  
                constexpr std::ptrdiff_t m_bLightDynamic2 = 0x6C5;  
                constexpr std::ptrdiff_t m_bLightDynamic3 = 0x6C6;  
                constexpr std::ptrdiff_t m_bLightDynamic4 = 0x6C7;  
                constexpr std::ptrdiff_t m_bUseNormal = 0x6C8;  
                constexpr std::ptrdiff_t m_bUseHLambert = 0x6C9;  
                constexpr std::ptrdiff_t m_bClampLowerRange = 0x6CE;  
                constexpr std::ptrdiff_t m_bClampUpperRange = 0x6CF;  
            }
            namespace C_OP_VectorFieldSnapshot {
                ...
                constexpr std::ptrdiff_t m_vecScale = 0x330;  
                constexpr std::ptrdiff_t m_flBoundaryDampening = 0x9A8;  
                constexpr std::ptrdiff_t m_bSetVelocity = 0x9AC;  
                constexpr std::ptrdiff_t m_bLockToSurface = 0x9AD;  
                constexpr std::ptrdiff_t m_flGridSpacing = 0x9B0;  
            }
            namespace C_OP_CylindricalDistanceToTransform {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C0;  
                constexpr std::ptrdiff_t m_flInputMin = 0x1C8;  
                constexpr std::ptrdiff_t m_flInputMax = 0x328;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x488;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x5E8;  
                constexpr std::ptrdiff_t m_TransformStart = 0x748;  
                constexpr std::ptrdiff_t m_TransformEnd = 0x7B0;  
                ...
                constexpr std::ptrdiff_t m_bCapsule = 0x81E;  
            }
            namespace C_INIT_PositionPlaceOnGround {
                constexpr std::ptrdiff_t m_flOffset = 0x1C8;  
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x328;  
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x488;  
                constexpr std::ptrdiff_t m_nTraceSet = 0x508;  
                constexpr std::ptrdiff_t m_nTraceMissBehavior = 0x518;  
                constexpr std::ptrdiff_t m_bIncludeWater = 0x51C;  
                constexpr std::ptrdiff_t m_bSetNormal = 0x51D;  
                constexpr std::ptrdiff_t m_bSetPXYZOnly = 0x51E;  
                constexpr std::ptrdiff_t m_bTraceAlongNormal = 0x51F;  
                constexpr std::ptrdiff_t m_bOffsetonColOnly = 0x520;  
                constexpr std::ptrdiff_t m_flOffsetByRadiusFactor = 0x524;  
                constexpr std::ptrdiff_t m_nPreserveOffsetCP = 0x528;  
                constexpr std::ptrdiff_t m_nIgnoreCP = 0x52C;  
            }
            namespace C_INIT_RandomScalar {
                constexpr std::ptrdiff_t m_flMin = 0x1C8;  
                constexpr std::ptrdiff_t m_flMax = 0x1CC;  
                constexpr std::ptrdiff_t m_flExponent = 0x1D0;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D4;  
            }
            ...
            namespace C_OP_WorldTraceConstraint {
                ...
                constexpr std::ptrdiff_t m_flBounceAmount = 0x3D8;  
                constexpr std::ptrdiff_t m_flSlideAmount = 0x538;  
                constexpr std::ptrdiff_t m_flRandomDirScale = 0x698;  
                constexpr std::ptrdiff_t m_bDecayBounce = 0x7F8;  
                constexpr std::ptrdiff_t m_bKillonContact = 0x7F9;  
                constexpr std::ptrdiff_t m_flMinSpeed = 0x7FC;  
                constexpr std::ptrdiff_t m_bSetNormal = 0x800;  
                constexpr std::ptrdiff_t m_nStickOnCollisionField = 0x804;  
                constexpr std::ptrdiff_t m_flStopSpeed = 0x808;  
                constexpr std::ptrdiff_t m_nEntityStickDataField = 0x968;  
                constexpr std::ptrdiff_t m_nEntityStickNormalField = 0x96C;  
            }
            namespace CParticleCollectionVecInput {
            }
            namespace C_OP_RenderBlobs {
                constexpr std::ptrdiff_t m_cubeWidth = 0x210;  
                constexpr std::ptrdiff_t m_cutoffRadius = 0x370;  
                constexpr std::ptrdiff_t m_renderRadius = 0x4D0;  
            ...
            namespace C_INIT_RandomSequence {
                constexpr std::ptrdiff_t m_nSequenceMin = 0x1C8;  
            ...
            namespace C_INIT_DistanceCull {
                ...
                constexpr std::ptrdiff_t m_bCullInside = 0x330;  
            }
            namespace C_OP_CollideWithParentParticles {
                constexpr std::ptrdiff_t m_flParentRadiusScale = 0x1C0;  
                constexpr std::ptrdiff_t m_flRadiusScale = 0x320;  
            }
            namespace C_INIT_InitFromVectorFieldSnapshot {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nLocalSpaceCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nWeightUpdateCP = 0x1D0;  
                constexpr std::ptrdiff_t m_bUseVerticalVelocity = 0x1D4;  
            ...
            namespace C_OP_SetVectorAttributeToVectorExpression {
                ...
                constexpr std::ptrdiff_t m_vInput2 = 0x840;  
                constexpr std::ptrdiff_t m_nOutputField = 0xEB8;  
                constexpr std::ptrdiff_t m_nSetMethod = 0xEBC;  
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0xEC0;  
            }
            namespace C_INIT_AddVectorToVector {
                ...
                constexpr std::ptrdiff_t m_vOffsetMin = 0x1DC;  
                constexpr std::ptrdiff_t m_vOffsetMax = 0x1E8;  
            ...
            namespace C_OP_RenderStatusEffect {
                constexpr std::ptrdiff_t m_pTextureColorWarp = 0x210;  
                constexpr std::ptrdiff_t m_pTextureDetail2 = 0x218;  
                constexpr std::ptrdiff_t m_pTextureDiffuseWarp = 0x220;  
                constexpr std::ptrdiff_t m_pTextureFresnelColorWarp = 0x228;  
                constexpr std::ptrdiff_t m_pTextureFresnelWarp = 0x230;  
                constexpr std::ptrdiff_t m_pTextureSpecularWarp = 0x238;  
                constexpr std::ptrdiff_t m_pTextureEnvMap = 0x240;  
            }
            ...
            namespace C_OP_SetFloat {
                constexpr std::ptrdiff_t m_InputValue = 0x1C0;  
                constexpr std::ptrdiff_t m_nOutputField = 0x320;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x324;  
                constexpr std::ptrdiff_t m_Lerp = 0x328;  
            }
            namespace C_INIT_RemapTransformToVector {
                ...
                constexpr std::ptrdiff_t m_TransformInput = 0x200;  
                constexpr std::ptrdiff_t m_LocalSpaceTransform = 0x268;  
                constexpr std::ptrdiff_t m_flStartTime = 0x2D0;  
                constexpr std::ptrdiff_t m_flEndTime = 0x2D4;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x2D8;  
                constexpr std::ptrdiff_t m_bOffset = 0x2DC;  
                constexpr std::ptrdiff_t m_bAccelerate = 0x2DD;  
                constexpr std::ptrdiff_t m_flRemapBias = 0x2E0;  
            }
            ...
            namespace C_OP_RemapDistanceToLineSegmentToScalar {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D8;  
                constexpr std::ptrdiff_t m_flMinOutputValue = 0x1DC;  
                constexpr std::ptrdiff_t m_flMaxOutputValue = 0x1E0;  
            }
            ...
            namespace C_OP_SetFromCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_nSnapShotIncrement = 0x338;  
                constexpr std::ptrdiff_t m_flInterpolation = 0x498;  
                constexpr std::ptrdiff_t m_bSubSample = 0x5F8;  
                constexpr std::ptrdiff_t m_bPrev = 0x5F9;  
            }
            namespace C_OP_DistanceBetweenCPsToCP {
                constexpr std::ptrdiff_t m_nStartCP = 0x1C8;  
                constexpr std::ptrdiff_t m_nEndCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nOutputCP = 0x1D0;  
                constexpr std::ptrdiff_t m_nOutputCPField = 0x1D4;  
                constexpr std::ptrdiff_t m_bSetOnce = 0x1D8;  
                ...
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x1EC;  
                constexpr std::ptrdiff_t m_flLOSScale = 0x1F0;  
            ...
            namespace C_OP_SetControlPointToHand {
                constexpr std::ptrdiff_t m_nCP1 = 0x1C8;  
                constexpr std::ptrdiff_t m_nHand = 0x1CC;  
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1D0;  
                constexpr std::ptrdiff_t m_bOrientToHand = 0x1DC;  
            }
            ...
            namespace C_OP_RemapSDFDistanceToScalarAttribute {
                ...
                constexpr std::ptrdiff_t m_flMinDistance = 0x1C8;  
                constexpr std::ptrdiff_t m_flMaxDistance = 0x328;  
                constexpr std::ptrdiff_t m_flValueBelowMin = 0x488;  
                constexpr std::ptrdiff_t m_flValueAtMin = 0x5E8;  
                constexpr std::ptrdiff_t m_flValueAtMax = 0x748;  
                constexpr std::ptrdiff_t m_flValueAboveMax = 0x8A8;  
            }
            ...
            namespace C_OP_RenderLights {
                constexpr std::ptrdiff_t m_flAnimationRate = 0x218;  
                constexpr std::ptrdiff_t m_nAnimationType = 0x21C;  
                constexpr std::ptrdiff_t m_bAnimateInFPS = 0x220;  
                constexpr std::ptrdiff_t m_flMinSize = 0x224;  
                constexpr std::ptrdiff_t m_flMaxSize = 0x228;  
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x22C;  
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x230;  
            }
            ...
            namespace C_INIT_ColorLitPerParticle {
                constexpr std::ptrdiff_t m_ColorMin = 0x1E0;  
                constexpr std::ptrdiff_t m_ColorMax = 0x1E4;  
                constexpr std::ptrdiff_t m_TintMin = 0x1E8;  
                constexpr std::ptrdiff_t m_TintMax = 0x1EC;  
                constexpr std::ptrdiff_t m_flTintPerc = 0x1F0;  
                constexpr std::ptrdiff_t m_nTintBlendMode = 0x1F4;  
                constexpr std::ptrdiff_t m_flLightAmplification = 0x1F8;  
            }
            namespace C_OP_RenderPoints {
                constexpr std::ptrdiff_t m_hMaterial = 0x210;  
            }
            namespace C_INIT_SetAttributeToScalarExpression {
                ...
                constexpr std::ptrdiff_t m_flInput2 = 0x330;  
                constexpr std::ptrdiff_t m_flOutputRemap = 0x490;  
                constexpr std::ptrdiff_t m_nOutputField = 0x5F0;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x5F4;  
            }
            namespace C_INIT_CreateOnGrid {
                constexpr std::ptrdiff_t m_nXCount = 0x1C8;  
                constexpr std::ptrdiff_t m_nYCount = 0x328;  
                constexpr std::ptrdiff_t m_nZCount = 0x488;  
                constexpr std::ptrdiff_t m_nXSpacing = 0x5E8;  
                constexpr std::ptrdiff_t m_nYSpacing = 0x748;  
                constexpr std::ptrdiff_t m_nZSpacing = 0x8A8;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0xA08;  
                constexpr std::ptrdiff_t m_bLocalSpace = 0xA0C;  
                constexpr std::ptrdiff_t m_bCenter = 0xA0D;  
                constexpr std::ptrdiff_t m_bHollow = 0xA0E;  
            }
            namespace C_OP_RampCPLinearRandom {
                constexpr std::ptrdiff_t m_nOutControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_vecRateMin = 0x1CC;  
                constexpr std::ptrdiff_t m_vecRateMax = 0x1D8;  
            }
            namespace C_OP_VelocityMatchingForce {
                constexpr std::ptrdiff_t m_flDirScale = 0x1C0;  
                constexpr std::ptrdiff_t m_flSpdScale = 0x1C4;  
                constexpr std::ptrdiff_t m_flNeighborDistance = 0x1C8;  
                constexpr std::ptrdiff_t m_flFacingStrength = 0x1CC;  
                constexpr std::ptrdiff_t m_bUseAABB = 0x1D0;  
                constexpr std::ptrdiff_t m_nCPBroadcast = 0x1D4;  
            }
            ...
            namespace C_INIT_CreateOnModelAtHeight {
                constexpr std::ptrdiff_t m_bUseBones = 0x1C8;  
                constexpr std::ptrdiff_t m_bForceZ = 0x1C9;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1CC;  
                constexpr std::ptrdiff_t m_nHeightCP = 0x1D0;  
                constexpr std::ptrdiff_t m_bUseWaterHeight = 0x1D4;  
                constexpr std::ptrdiff_t m_flDesiredHeight = 0x1D8;  
                constexpr std::ptrdiff_t m_vecHitBoxScale = 0x338;  
                constexpr std::ptrdiff_t m_vecDirectionBias = 0x9B0;  
                constexpr std::ptrdiff_t m_nBiasType = 0x1028;  
                constexpr std::ptrdiff_t m_bLocalCoords = 0x102C;  
                constexpr std::ptrdiff_t m_bPreferMovingBoxes = 0x102D;  
                constexpr std::ptrdiff_t m_HitboxSetName = 0x102E;  
                constexpr std::ptrdiff_t m_flHitboxVelocityScale = 0x10B0;  
                constexpr std::ptrdiff_t m_flMaxBoneVelocity = 0x1210;  
            }
            ...
            namespace C_INIT_CreateSequentialPathV2 {
                constexpr std::ptrdiff_t m_fMaxDistance = 0x1C8;  
                constexpr std::ptrdiff_t m_flNumToAssign = 0x328;  
                constexpr std::ptrdiff_t m_bLoop = 0x488;  
                constexpr std::ptrdiff_t m_bCPPairs = 0x489;  
                constexpr std::ptrdiff_t m_bSaveOffset = 0x48A;  
            ...
            namespace C_INIT_RemapInitialDirectionToTransformToVector {
                constexpr std::ptrdiff_t m_TransformInput = 0x1C8;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x230;  
                constexpr std::ptrdiff_t m_flScale = 0x234;  
                constexpr std::ptrdiff_t m_flOffsetRot = 0x238;  
                constexpr std::ptrdiff_t m_vecOffsetAxis = 0x23C;  
                constexpr std::ptrdiff_t m_bNormalize = 0x248;  
            }
            ...
            namespace C_INIT_RemapTransformOrientationToRotations {
                constexpr std::ptrdiff_t m_TransformInput = 0x1C8;  
                constexpr std::ptrdiff_t m_vecRotation = 0x230;  
                constexpr std::ptrdiff_t m_bUseQuat = 0x23C;  
                constexpr std::ptrdiff_t m_bWriteNormal = 0x23D;  
            }
            namespace C_OP_Cull {
            ...
            namespace C_INIT_RandomYawFlip {
                constexpr std::ptrdiff_t m_flPercent = 0x1C8;  
            }
            ...
            namespace C_OP_ReadFromNeighboringParticle {
                ...
                constexpr std::ptrdiff_t m_flInterpolation = 0x330;  
            }
            namespace C_OP_RenderText {
                constexpr std::ptrdiff_t m_OutlineColor = 0x210;  
                constexpr std::ptrdiff_t m_DefaultText = 0x218;  
            }
            namespace C_OP_LerpToInitialPosition {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C0;  
                constexpr std::ptrdiff_t m_flInterpolation = 0x1C8;  
                constexpr std::ptrdiff_t m_nCacheField = 0x328;  
                constexpr std::ptrdiff_t m_flScale = 0x330;  
                constexpr std::ptrdiff_t m_vecScale = 0x490;  
            }
            ...
            namespace C_OP_SetCPOrientationToPointAtCP {
                constexpr std::ptrdiff_t m_nInputCP = 0x1C8;  
                constexpr std::ptrdiff_t m_nOutputCP = 0x1CC;  
                constexpr std::ptrdiff_t m_flInterpolation = 0x1D0;  
            ...
            namespace C_OP_MovementPlaceOnGround {
                ...
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x320;  
                constexpr std::ptrdiff_t m_flTolerance = 0x324;  
                constexpr std::ptrdiff_t m_flTraceOffset = 0x328;  
                constexpr std::ptrdiff_t m_flLerpRate = 0x32C;  
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x330;  
                constexpr std::ptrdiff_t m_nTraceSet = 0x3B0;  
                constexpr std::ptrdiff_t m_nRefCP1 = 0x3B4;  
                constexpr std::ptrdiff_t m_nRefCP2 = 0x3B8;  
                constexpr std::ptrdiff_t m_nLerpCP = 0x3BC;  
                constexpr std::ptrdiff_t m_nTraceMissBehavior = 0x3C8;  
                constexpr std::ptrdiff_t m_bIncludeShotHull = 0x3CC;  
                constexpr std::ptrdiff_t m_bIncludeWater = 0x3CD;  
                constexpr std::ptrdiff_t m_bSetNormal = 0x3D0;  
                constexpr std::ptrdiff_t m_bScaleOffset = 0x3D1;  
                constexpr std::ptrdiff_t m_nPreserveOffsetCP = 0x3D4;  
                constexpr std::ptrdiff_t m_nIgnoreCP = 0x3D8;  
            }
            ...
            namespace C_OP_RemapCrossProductOfTwoVectorsToVector {
                ...
                constexpr std::ptrdiff_t m_InputVec2 = 0x838;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0xEB0;  
                constexpr std::ptrdiff_t m_bNormalize = 0xEB4;  
            }
            ...
            namespace C_OP_SetControlPointPositionToRandomActiveCP {
                constexpr std::ptrdiff_t m_nCP1 = 0x1C8;  
                constexpr std::ptrdiff_t m_nHeadLocationMin = 0x1CC;  
                constexpr std::ptrdiff_t m_nHeadLocationMax = 0x1D0;  
                constexpr std::ptrdiff_t m_flResetRate = 0x1D8;  
            }
            ...
            namespace C_INIT_AgeNoise {
                constexpr std::ptrdiff_t m_bAbsVal = 0x1C8;  
                constexpr std::ptrdiff_t m_bAbsValInv = 0x1C9;  
                constexpr std::ptrdiff_t m_flOffset = 0x1CC;  
                constexpr std::ptrdiff_t m_flAgeMin = 0x1D0;  
                constexpr std::ptrdiff_t m_flAgeMax = 0x1D4;  
                constexpr std::ptrdiff_t m_flNoiseScale = 0x1D8;  
                constexpr std::ptrdiff_t m_flNoiseScaleLoc = 0x1DC;  
                constexpr std::ptrdiff_t m_vecOffsetLoc = 0x1E0;  
            }
            ...
            namespace CGeneralRandomRotation {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_flDegrees = 0x1CC;  
                constexpr std::ptrdiff_t m_flDegreesMin = 0x1D0;  
                constexpr std::ptrdiff_t m_flDegreesMax = 0x1D4;  
                constexpr std::ptrdiff_t m_flRotationRandExponent = 0x1D8;  
                constexpr std::ptrdiff_t m_bRandomlyFlipDirection = 0x1DC;  
            }
            namespace C_OP_DistanceBetweenVecs {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C0;  
                constexpr std::ptrdiff_t m_vecPoint1 = 0x1C8;  
                constexpr std::ptrdiff_t m_vecPoint2 = 0x840;  
                constexpr std::ptrdiff_t m_flInputMin = 0xEB8;  
                constexpr std::ptrdiff_t m_flInputMax = 0x1018;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1178;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x12D8;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x1438;  
                constexpr std::ptrdiff_t m_bDeltaTime = 0x143C;  
            }
            ...
            namespace C_OP_LockToBone {
                ...
                constexpr std::ptrdiff_t m_flRotLerp = 0x9A8;  
            }
            ...
            namespace C_OP_SetVec {
                ...
                constexpr std::ptrdiff_t m_nOutputField = 0x838;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x83C;  
                constexpr std::ptrdiff_t m_Lerp = 0x840;  
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0x9A0;  
            }
            namespace C_INIT_CreateFromParentParticles {
                constexpr std::ptrdiff_t m_flVelocityScale = 0x1C8;  
                constexpr std::ptrdiff_t m_flIncrement = 0x1CC;  
                constexpr std::ptrdiff_t m_bRandomDistribution = 0x1D0;  
                constexpr std::ptrdiff_t m_nRandomSeed = 0x1D4;  
                constexpr std::ptrdiff_t m_bSubFrame = 0x1D8;  
            }
            ...
            namespace C_OP_RenderOmni2Light {
                ...
                constexpr std::ptrdiff_t m_flBrightnessLumens = 0x898;  
                constexpr std::ptrdiff_t m_flBrightnessCandelas = 0x9F8;  
                constexpr std::ptrdiff_t m_bCastShadows = 0xB58;  
                constexpr std::ptrdiff_t m_bFog = 0xB59;  
                constexpr std::ptrdiff_t m_flFogScale = 0xB60;  
                constexpr std::ptrdiff_t m_flLuminaireRadius = 0xCC0;  
                constexpr std::ptrdiff_t m_flSkirt = 0xE20;  
                constexpr std::ptrdiff_t m_flRange = 0xF80;  
                constexpr std::ptrdiff_t m_flInnerConeAngle = 0x10E0;  
                constexpr std::ptrdiff_t m_flOuterConeAngle = 0x1240;  
                constexpr std::ptrdiff_t m_hLightCookie = 0x13A0;  
                constexpr std::ptrdiff_t m_bSphericalCookie = 0x13A8;  
            }
            namespace C_OP_ConnectParentParticleToNearest {
                ...
                constexpr std::ptrdiff_t m_bUseRadius = 0x1C8;  
                constexpr std::ptrdiff_t m_flRadiusScale = 0x1D0;  
                constexpr std::ptrdiff_t m_flParentRadiusScale = 0x330;  
            }
            ...
            namespace C_INIT_InitSkinnedPositionFromCPSnapshot {
                constexpr std::ptrdiff_t m_nSnapshotControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1CC;  
                constexpr std::ptrdiff_t m_bRandom = 0x1D0;  
                constexpr std::ptrdiff_t m_nRandomSeed = 0x1D4;  
                constexpr std::ptrdiff_t m_bRigid = 0x1D8;  
                constexpr std::ptrdiff_t m_bSetNormal = 0x1D9;  
                constexpr std::ptrdiff_t m_bIgnoreDt = 0x1DA;  
                constexpr std::ptrdiff_t m_flMinNormalVelocity = 0x1DC;  
                constexpr std::ptrdiff_t m_flMaxNormalVelocity = 0x1E0;  
                constexpr std::ptrdiff_t m_nIndexType = 0x1E4;  
                constexpr std::ptrdiff_t m_flReadIndex = 0x1E8;  
                constexpr std::ptrdiff_t m_flIncrement = 0x348;  
                constexpr std::ptrdiff_t m_nFullLoopIncrement = 0x34C;  
                constexpr std::ptrdiff_t m_nSnapShotStartPoint = 0x350;  
                constexpr std::ptrdiff_t m_flBoneVelocity = 0x354;  
                constexpr std::ptrdiff_t m_flBoneVelocityMax = 0x358;  
                constexpr std::ptrdiff_t m_bCopyColor = 0x35C;  
                constexpr std::ptrdiff_t m_bCopyAlpha = 0x35D;  
                constexpr std::ptrdiff_t m_bSetRadius = 0x35E;  
            }
            ...
            namespace C_OP_ColorAdjustHSL {
                ...
                constexpr std::ptrdiff_t m_flSaturationAdjust = 0x320;  
                constexpr std::ptrdiff_t m_flLightnessAdjust = 0x480;  
            }
            namespace CParticleMassCalculationParameters {
                ...
                constexpr std::ptrdiff_t m_flNominalRadius = 0x168;  
                constexpr std::ptrdiff_t m_flScale = 0x2C8;  
            }
            ...
            namespace C_INIT_InitVec {
                constexpr std::ptrdiff_t m_InputValue = 0x1C8;  
                constexpr std::ptrdiff_t m_nOutputField = 0x840;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x844;  
                constexpr std::ptrdiff_t m_bNormalizedOutput = 0x848;  
                constexpr std::ptrdiff_t m_bWritePreviousPosition = 0x849;  
            }
            namespace C_INIT_SetHitboxToModel {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nForceInModel = 0x1CC;  
                constexpr std::ptrdiff_t m_bEvenDistribution = 0x1D0;  
                constexpr std::ptrdiff_t m_nDesiredHitbox = 0x1D4;  
                constexpr std::ptrdiff_t m_vecHitBoxScale = 0x1D8;  
                constexpr std::ptrdiff_t m_vecDirectionBias = 0x850;  
                constexpr std::ptrdiff_t m_bMaintainHitbox = 0x85C;  
                constexpr std::ptrdiff_t m_bUseBones = 0x85D;  
                constexpr std::ptrdiff_t m_HitboxSetName = 0x85E;  
                constexpr std::ptrdiff_t m_flShellSize = 0x8E0;  
            }
            namespace C_OP_MovementMoveAlongSkinnedCPSnapshot {
                ...
                constexpr std::ptrdiff_t m_flInterpolation = 0x1D0;  
                constexpr std::ptrdiff_t m_flTValue = 0x330;  
            }
            namespace C_OP_LerpScalar {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C0;  
                constexpr std::ptrdiff_t m_flOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_flStartTime = 0x328;  
                constexpr std::ptrdiff_t m_flEndTime = 0x32C;  
            }
            namespace C_INIT_InitialRepulsionVelocity {
                ...
                constexpr std::ptrdiff_t m_vecOutputMin = 0x24C;  
                constexpr std::ptrdiff_t m_vecOutputMax = 0x258;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x264;  
                constexpr std::ptrdiff_t m_bPerParticle = 0x268;  
                constexpr std::ptrdiff_t m_bTranslate = 0x269;  
                constexpr std::ptrdiff_t m_bProportional = 0x26A;  
                constexpr std::ptrdiff_t m_flTraceLength = 0x26C;  
                constexpr std::ptrdiff_t m_bPerParticleTR = 0x270;  
                constexpr std::ptrdiff_t m_bInherit = 0x271;  
                constexpr std::ptrdiff_t m_nChildCP = 0x274;  
                constexpr std::ptrdiff_t m_nChildGroupID = 0x278;  
            }
            namespace C_OP_ClampScalar {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C0;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1C8;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x328;  
            }
            namespace C_OP_SetControlPointToHMD {
                constexpr std::ptrdiff_t m_nCP1 = 0x1C8;  
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1CC;  
                constexpr std::ptrdiff_t m_bOrientToHMD = 0x1D8;  
            }
            ...
            namespace C_OP_SetControlPointFieldFromVectorExpression {
                constexpr std::ptrdiff_t m_nExpression = 0x1C8;  
                constexpr std::ptrdiff_t m_vecInput1 = 0x1D0;  
                constexpr std::ptrdiff_t m_vecInput2 = 0x848;  
                constexpr std::ptrdiff_t m_flOutputRemap = 0xEC0;  
                constexpr std::ptrdiff_t m_nOutputCP = 0x1020;  
                constexpr std::ptrdiff_t m_nOutVectorField = 0x1024;  
            }
            ...
            namespace C_INIT_InitFromCPSnapshot {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nAttributeToRead = 0x1CC;  
                constexpr std::ptrdiff_t m_nAttributeToWrite = 0x1D0;  
                constexpr std::ptrdiff_t m_nLocalSpaceCP = 0x1D4;  
                constexpr std::ptrdiff_t m_bRandom = 0x1D8;  
                constexpr std::ptrdiff_t m_bReverse = 0x1D9;  
                constexpr std::ptrdiff_t m_nSnapShotIncrement = 0x1E0;  
                constexpr std::ptrdiff_t m_nManualSnapshotIndex = 0x340;  
                constexpr std::ptrdiff_t m_nRandomSeed = 0x4A0;  
                constexpr std::ptrdiff_t m_bLocalSpaceAngles = 0x4A4;  
            }
            namespace C_OP_RenderCables {
                constexpr std::ptrdiff_t m_flRadiusScale = 0x210;  
                constexpr std::ptrdiff_t m_flAlphaScale = 0x370;  
                constexpr std::ptrdiff_t m_vecColorScale = 0x4D0;  
                constexpr std::ptrdiff_t m_nColorBlendType = 0xB48;  
                constexpr std::ptrdiff_t m_hMaterial = 0xB50;  
                constexpr std::ptrdiff_t m_nTextureRepetitionMode = 0xB58;  
                constexpr std::ptrdiff_t m_flTextureRepeatsPerSegment = 0xB60;  
                constexpr std::ptrdiff_t m_flTextureRepeatsCircumference = 0xCC0;  
                constexpr std::ptrdiff_t m_flColorMapOffsetV = 0xE20;  
                constexpr std::ptrdiff_t m_flColorMapOffsetU = 0xF80;  
                constexpr std::ptrdiff_t m_flNormalMapOffsetV = 0x10E0;  
                constexpr std::ptrdiff_t m_flNormalMapOffsetU = 0x1240;  
                constexpr std::ptrdiff_t m_bDrawCableCaps = 0x13A0;  
                constexpr std::ptrdiff_t m_flCapRoundness = 0x13A4;  
                constexpr std::ptrdiff_t m_flCapOffsetAmount = 0x13A8;  
                constexpr std::ptrdiff_t m_flTessScale = 0x13AC;  
                constexpr std::ptrdiff_t m_nMinTesselation = 0x13B0;  
                constexpr std::ptrdiff_t m_nMaxTesselation = 0x13B4;  
                constexpr std::ptrdiff_t m_nRoundness = 0x13B8;  
                constexpr std::ptrdiff_t m_LightingTransform = 0x13C0;  
                constexpr std::ptrdiff_t m_MaterialFloatVars = 0x1428;  
                constexpr std::ptrdiff_t m_MaterialVecVars = 0x1458;  
            }
            namespace C_INIT_InheritVelocity {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_flVelocityScale = 0x1CC;  
            }
            namespace C_OP_SetControlPointToWaterSurface {
                constexpr std::ptrdiff_t m_nSourceCP = 0x1C8;  
                constexpr std::ptrdiff_t m_nDestCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nFlowCP = 0x1D0;  
                constexpr std::ptrdiff_t m_nActiveCP = 0x1D4;  
                constexpr std::ptrdiff_t m_nActiveCPField = 0x1D8;  
            ...
            namespace C_INIT_PositionOffset {
                constexpr std::ptrdiff_t m_OffsetMin = 0x1C8;  
                constexpr std::ptrdiff_t m_OffsetMax = 0x840;  
                constexpr std::ptrdiff_t m_TransformInput = 0xEB8;  
                constexpr std::ptrdiff_t m_bLocalCoords = 0xF20;  
                constexpr std::ptrdiff_t m_bProportional = 0xF21;  
                constexpr std::ptrdiff_t m_randomnessParameters = 0xF24;  
            }
            namespace C_INIT_NormalAlignToCP {
                constexpr std::ptrdiff_t m_transformInput = 0x1C8;  
                constexpr std::ptrdiff_t m_nControlPointAxis = 0x230;  
            }
            ...
            namespace C_OP_SetChildControlPoints {
                ...
                constexpr std::ptrdiff_t m_nNumControlPoints = 0x1C8;  
                constexpr std::ptrdiff_t m_nFirstSourcePoint = 0x1D0;  
                constexpr std::ptrdiff_t m_bReverse = 0x330;  
                constexpr std::ptrdiff_t m_bSetOrientation = 0x331;  
            }
            namespace C_OP_ChladniWave {
                ...
                constexpr std::ptrdiff_t m_flOutputMin = 0x488;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x5E8;  
                constexpr std::ptrdiff_t m_vecWaveLength = 0x748;  
                constexpr std::ptrdiff_t m_vecHarmonics = 0xDC0;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x1438;  
                constexpr std::ptrdiff_t m_nLocalSpaceControlPoint = 0x143C;  
                constexpr std::ptrdiff_t m_b3D = 0x1440;  
            }
            ...
            namespace C_OP_DriveCPFromGlobalSoundFloat {
                constexpr std::ptrdiff_t m_nOutputControlPoint = 0x1C8;  
                constexpr std::ptrdiff_t m_nOutputField = 0x1CC;  
                constexpr std::ptrdiff_t m_flInputMin = 0x1D0;  
                constexpr std::ptrdiff_t m_flInputMax = 0x1D4;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1D8;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x1DC;  
                constexpr std::ptrdiff_t m_StackName = 0x1E0;  
                constexpr std::ptrdiff_t m_OperatorName = 0x1E8;  
                constexpr std::ptrdiff_t m_FieldName = 0x1F0;  
            }
            ...
            namespace C_OP_PinParticleToCP {
                ...
                constexpr std::ptrdiff_t m_bOffsetLocal = 0x840;  
                constexpr std::ptrdiff_t m_nParticleSelection = 0x844;  
                constexpr std::ptrdiff_t m_nParticleNumber = 0x848;  
                constexpr std::ptrdiff_t m_nPinBreakType = 0x9A8;  
                constexpr std::ptrdiff_t m_flBreakDistance = 0x9B0;  
                constexpr std::ptrdiff_t m_flBreakSpeed = 0xB10;  
                constexpr std::ptrdiff_t m_flAge = 0xC70;  
                constexpr std::ptrdiff_t m_nBreakControlPointNumber = 0xDD0;  
                constexpr std::ptrdiff_t m_nBreakControlPointNumber2 = 0xDD4;  
                constexpr std::ptrdiff_t m_flBreakValue = 0xDD8;  
                constexpr std::ptrdiff_t m_flInterpolation = 0xF38;  
            }
            ...
            namespace C_INIT_CreateParticleImpulse {
                constexpr std::ptrdiff_t m_InputRadius = 0x1C8;  
                constexpr std::ptrdiff_t m_InputMagnitude = 0x328;  
                constexpr std::ptrdiff_t m_nFalloffFunction = 0x488;  
                constexpr std::ptrdiff_t m_InputFalloffExp = 0x490;  
            ...
            namespace C_INIT_CreateInEpitrochoid {
                ...
                constexpr std::ptrdiff_t m_nComponent2 = 0x1CC;  
                constexpr std::ptrdiff_t m_TransformInput = 0x1D0;  
                constexpr std::ptrdiff_t m_flParticleDensity = 0x238;  
                constexpr std::ptrdiff_t m_flOffset = 0x398;  
                constexpr std::ptrdiff_t m_flRadius1 = 0x4F8;  
                constexpr std::ptrdiff_t m_flRadius2 = 0x658;  
                constexpr std::ptrdiff_t m_bUseCount = 0x7B8;  
                constexpr std::ptrdiff_t m_bUseLocalCoords = 0x7B9;  
                constexpr std::ptrdiff_t m_bOffsetExistingPos = 0x7BA;  
            }
            ...
            namespace C_OP_SetControlPointPositions {
                constexpr std::ptrdiff_t m_bUseWorldLocation = 0x1C8;  
                constexpr std::ptrdiff_t m_bOrient = 0x1C9;  
                constexpr std::ptrdiff_t m_bSetOnce = 0x1CA;  
                constexpr std::ptrdiff_t m_nCP1 = 0x1CC;  
                constexpr std::ptrdiff_t m_nCP2 = 0x1D0;  
                constexpr std::ptrdiff_t m_nCP3 = 0x1D4;  
                constexpr std::ptrdiff_t m_nCP4 = 0x1D8;  
                constexpr std::ptrdiff_t m_vecCP1Pos = 0x1DC;  
                constexpr std::ptrdiff_t m_vecCP2Pos = 0x1E8;  
                constexpr std::ptrdiff_t m_vecCP3Pos = 0x1F4;  
                constexpr std::ptrdiff_t m_vecCP4Pos = 0x200;  
                constexpr std::ptrdiff_t m_nHeadLocation = 0x20C;  
            }
            namespace C_OP_SetFloatAttributeToVectorExpression {
                constexpr std::ptrdiff_t m_nExpression = 0x1C0;  
                constexpr std::ptrdiff_t m_vInput1 = 0x1C8;  
                constexpr std::ptrdiff_t m_vInput2 = 0x840;  
                constexpr std::ptrdiff_t m_flOutputRemap = 0xEB8;  
                constexpr std::ptrdiff_t m_nOutputField = 0x1018;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x101C;  
            }
            namespace C_OP_MovementRotateParticleAroundAxis {
                constexpr std::ptrdiff_t m_vecRotAxis = 0x1C0;  
                constexpr std::ptrdiff_t m_flRotRate = 0x838;  
                constexpr std::ptrdiff_t m_TransformInput = 0x998;  
                constexpr std::ptrdiff_t m_bLocalSpace = 0xA00;  
            }
            namespace C_OP_IntraParticleForce {
                constexpr std::ptrdiff_t m_flAttractionMinDistance = 0x1D0;  
                constexpr std::ptrdiff_t m_flAttractionMaxDistance = 0x1D4;  
                constexpr std::ptrdiff_t m_flAttractionMaxStrength = 0x1D8;  
                constexpr std::ptrdiff_t m_flRepulsionMinDistance = 0x1DC;  
                constexpr std::ptrdiff_t m_flRepulsionMaxDistance = 0x1E0;  
                constexpr std::ptrdiff_t m_flRepulsionMaxStrength = 0x1E4;  
                constexpr std::ptrdiff_t m_bUseAABB = 0x1E8;  
                constexpr std::ptrdiff_t m_bThreadIt = 0x1E9;  
            }
            namespace C_INIT_InitFloat {
                constexpr std::ptrdiff_t m_InputValue = 0x1C8;  
                constexpr std::ptrdiff_t m_nOutputField = 0x328;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x32C;  
                constexpr std::ptrdiff_t m_InputStrength = 0x330;  
            }
            namespace C_INIT_CreateOnModel {
                ...
                constexpr std::ptrdiff_t m_bEvenDistribution = 0x295;  
                constexpr std::ptrdiff_t m_nDesiredHitbox = 0x298;  
                constexpr std::ptrdiff_t m_nHitboxValueFromControlPointIndex = 0x3F8;  
                constexpr std::ptrdiff_t m_vecHitBoxScale = 0x400;  
                constexpr std::ptrdiff_t m_flBoneVelocity = 0xA78;  
                constexpr std::ptrdiff_t m_flMaxBoneVelocity = 0xA7C;  
                constexpr std::ptrdiff_t m_vecDirectionBias = 0xA80;  
                constexpr std::ptrdiff_t m_HitboxSetName = 0x10F8;  
                constexpr std::ptrdiff_t m_bLocalCoords = 0x1178;  
                constexpr std::ptrdiff_t m_bUseBones = 0x1179;  
                constexpr std::ptrdiff_t m_bUseMesh = 0x117A;  
                constexpr std::ptrdiff_t m_flShellSize = 0x1180;  
            }
            ...
            namespace C_OP_PerParticleForce {
                constexpr std::ptrdiff_t m_flForceScale = 0x1D0;  
                constexpr std::ptrdiff_t m_vForce = 0x330;  
                constexpr std::ptrdiff_t m_nCP = 0x9A8;  
            }
            namespace C_INIT_RandomNamedModelMeshGroup {
            }
            namespace C_OP_RenderProjected {
                constexpr std::ptrdiff_t m_bProjectCharacter = 0x210;  
                constexpr std::ptrdiff_t m_bProjectWorld = 0x211;  
                constexpr std::ptrdiff_t m_bProjectWater = 0x212;  
                constexpr std::ptrdiff_t m_bFlipHorizontal = 0x213;  
                constexpr std::ptrdiff_t m_bEnableProjectedDepthControls = 0x214;  
                constexpr std::ptrdiff_t m_flMinProjectionDepth = 0x218;  
                constexpr std::ptrdiff_t m_flMaxProjectionDepth = 0x21C;  
                ...
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x7D8;  
                constexpr std::ptrdiff_t m_vecColorScale = 0x7E0;  
            ...
            namespace C_INIT_VelocityFromNormal {
                ...
                constexpr std::ptrdiff_t m_fSpeedMax = 0x1CC;  
                constexpr std::ptrdiff_t m_bIgnoreDt = 0x1D0;  
            }
            namespace C_OP_MaintainEmitter {
                constexpr std::ptrdiff_t m_nParticlesToMaintain = 0x1C8;  
                constexpr std::ptrdiff_t m_flStartTime = 0x328;  
                constexpr std::ptrdiff_t m_flEmissionDuration = 0x330;  
                constexpr std::ptrdiff_t m_flEmissionRate = 0x490;  
                constexpr std::ptrdiff_t m_nSnapshotControlPoint = 0x494;  
                constexpr std::ptrdiff_t m_bEmitInstantaneously = 0x498;  
                constexpr std::ptrdiff_t m_bFinalEmitOnStop = 0x499;  
                constexpr std::ptrdiff_t m_flScale = 0x4A0;  
            }
            namespace C_INIT_PositionOffsetToCP {
                constexpr std::ptrdiff_t m_nControlPointNumberStart = 0x1C8;  
                constexpr std::ptrdiff_t m_nControlPointNumberEnd = 0x1CC;  
                constexpr std::ptrdiff_t m_bLocalCoords = 0x1D0;  
            }
            namespace C_INIT_RemapInitialTransformDirectionToRotation {
                constexpr std::ptrdiff_t m_TransformInput = 0x1C8;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x230;  
                constexpr std::ptrdiff_t m_flOffsetRot = 0x234;  
                constexpr std::ptrdiff_t m_nComponent = 0x238;  
            }
            ...
            namespace C_OP_SetControlPointFromObjectScale {
                constexpr std::ptrdiff_t m_nCPInput = 0x1C8;  
                constexpr std::ptrdiff_t m_nCPOutput = 0x1CC;  
            }
            ...
            namespace C_OP_StopAfterCPDuration {
                constexpr std::ptrdiff_t m_flDuration = 0x1C8;  
            ...
            namespace C_INIT_RemapNamedModelElementToScalar {
                ...
                constexpr std::ptrdiff_t m_nFieldInput = 0x200;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x204;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x208;  
                constexpr std::ptrdiff_t m_bModelFromRenderer = 0x20C;  
            }
            namespace C_OP_ClampVector {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C0;  
                constexpr std::ptrdiff_t m_vecOutputMin = 0x1C8;  
                constexpr std::ptrdiff_t m_vecOutputMax = 0x840;  
            }
            namespace C_OP_RenderStatusEffectCitadel {
                constexpr std::ptrdiff_t m_pTextureColorWarp = 0x210;  
                constexpr std::ptrdiff_t m_pTextureNormal = 0x218;  
                constexpr std::ptrdiff_t m_pTextureMetalness = 0x220;  
                constexpr std::ptrdiff_t m_pTextureRoughness = 0x228;  
                constexpr std::ptrdiff_t m_pTextureSelfIllum = 0x230;  
                constexpr std::ptrdiff_t m_pTextureDetail = 0x238;  
            }
            namespace C_INIT_RemapCPtoScalar {
                ...
                constexpr std::ptrdiff_t m_flEndTime = 0x1E8;  
            ...
            namespace C_OP_SetVariable {
                constexpr std::ptrdiff_t m_variableReference = 0x1C8;  
                constexpr std::ptrdiff_t m_transformInput = 0x208;  
                constexpr std::ptrdiff_t m_positionOffset = 0x270;  
                constexpr std::ptrdiff_t m_rotationOffset = 0x27C;  
                constexpr std::ptrdiff_t m_vecInput = 0x288;  
                constexpr std::ptrdiff_t m_floatInput = 0x900;  
            }
            namespace C_OP_RenderStandardLight {
                ...
                constexpr std::ptrdiff_t m_bCastShadows = 0x9F8;  
                ...
                constexpr std::ptrdiff_t m_bRenderDiffuse = 0x1248;  
                ...
                constexpr std::ptrdiff_t m_nPrevPntSource = 0x13CC;  
                constexpr std::ptrdiff_t m_flMaxLength = 0x13D0;  
                constexpr std::ptrdiff_t m_flMinLength = 0x13D4;  
                constexpr std::ptrdiff_t m_bIgnoreDT = 0x13D8;  
                constexpr std::ptrdiff_t m_flConstrainRadiusToLengthRatio = 0x13DC;  
                constexpr std::ptrdiff_t m_flLengthScale = 0x13E0;  
                constexpr std::ptrdiff_t m_flLengthFadeInTime = 0x13E4;  
            }
            namespace C_OP_DistanceToTransform {
                ...
                constexpr std::ptrdiff_t m_flOutputMax = 0x5E8;  
                constexpr std::ptrdiff_t m_TransformStart = 0x748;  
                constexpr std::ptrdiff_t m_bLOS = 0x7B0;  
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x7B1;  
                constexpr std::ptrdiff_t m_nTraceSet = 0x834;  
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x838;  
                constexpr std::ptrdiff_t m_flLOSScale = 0x83C;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x840;  
                constexpr std::ptrdiff_t m_bActiveRange = 0x844;  
                constexpr std::ptrdiff_t m_bAdditive = 0x845;  
                constexpr std::ptrdiff_t m_vecComponentScale = 0x848;  
            }
            ...
            namespace C_OP_RemapCPtoCP {
                constexpr std::ptrdiff_t m_nInputControlPoint = 0x1C8;  
                constexpr std::ptrdiff_t m_nOutputControlPoint = 0x1CC;  
                constexpr std::ptrdiff_t m_nInputField = 0x1D0;  
                constexpr std::ptrdiff_t m_nOutputField = 0x1D4;  
                constexpr std::ptrdiff_t m_flInputMin = 0x1D8;  
                constexpr std::ptrdiff_t m_flInputMax = 0x1DC;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1E0;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x1E4;  
                constexpr std::ptrdiff_t m_bDerivative = 0x1E8;  
                constexpr std::ptrdiff_t m_flInterpRate = 0x1EC;  
            }
            namespace C_OP_SetControlPointRotation {
                constexpr std::ptrdiff_t m_vecRotAxis = 0x1C8;  
                constexpr std::ptrdiff_t m_flRotRate = 0x840;  
                constexpr std::ptrdiff_t m_nCP = 0x9A0;  
                constexpr std::ptrdiff_t m_nLocalCP = 0x9A4;  
            }
            namespace C_OP_CurlNoiseForce {
                constexpr std::ptrdiff_t m_nNoiseType = 0x1D0;  
                constexpr std::ptrdiff_t m_vecNoiseFreq = 0x1D8;  
                constexpr std::ptrdiff_t m_vecNoiseScale = 0x850;  
                constexpr std::ptrdiff_t m_vecOffset = 0xEC8;  
                constexpr std::ptrdiff_t m_vecOffsetRate = 0x1540;  
                constexpr std::ptrdiff_t m_flWorleySeed = 0x1BB8;  
                constexpr std::ptrdiff_t m_flWorleyJitter = 0x1D18;  
            }
            namespace C_INIT_Orient2DRelToCP {
                constexpr std::ptrdiff_t m_nCP = 0x1C8;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1CC;  
                constexpr std::ptrdiff_t m_flRotOffset = 0x1D0;  
            }
            namespace C_OP_SetSimulationRate {
                constexpr std::ptrdiff_t m_flSimulationScale = 0x1C8;  
            }
            ...
            namespace C_OP_RenderScreenShake {
                constexpr std::ptrdiff_t m_flDurationScale = 0x210;  
                constexpr std::ptrdiff_t m_flRadiusScale = 0x214;  
                constexpr std::ptrdiff_t m_flFrequencyScale = 0x218;  
                constexpr std::ptrdiff_t m_flAmplitudeScale = 0x21C;  
                constexpr std::ptrdiff_t m_nRadiusField = 0x220;  
                constexpr std::ptrdiff_t m_nDurationField = 0x224;  
                constexpr std::ptrdiff_t m_nFrequencyField = 0x228;  
                constexpr std::ptrdiff_t m_nAmplitudeField = 0x22C;  
                constexpr std::ptrdiff_t m_nFilterCP = 0x230;  
            }
            ...
            namespace C_OP_HSVShiftToCP {
                constexpr std::ptrdiff_t m_nColorCP = 0x1C8;  
                constexpr std::ptrdiff_t m_nColorGemEnableCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nOutputCP = 0x1D0;  
                constexpr std::ptrdiff_t m_DefaultHSVColor = 0x1D4;  
            }
            namespace C_INIT_GlobalScale {
                constexpr std::ptrdiff_t m_flScale = 0x1C8;  
                constexpr std::ptrdiff_t m_nScaleControlPointNumber = 0x1CC;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D0;  
                constexpr std::ptrdiff_t m_bScaleRadius = 0x1D4;  
                constexpr std::ptrdiff_t m_bScalePosition = 0x1D5;  
                constexpr std::ptrdiff_t m_bScaleVelocity = 0x1D6;  
            }
            namespace C_INIT_RadiusFromCPObject {
                constexpr std::ptrdiff_t m_nControlPoint = 0x1C8;  
            }
            namespace C_INIT_InitialVelocityFromHitbox {
                constexpr std::ptrdiff_t m_flVelocityMin = 0x1C8;  
                constexpr std::ptrdiff_t m_flVelocityMax = 0x1CC;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1D0;  
                constexpr std::ptrdiff_t m_HitboxSetName = 0x1D4;  
                constexpr std::ptrdiff_t m_bUseBones = 0x254;  
            }
            ...
            namespace TextureGroup_t {
                ...
                constexpr std::ptrdiff_t m_TextureControls = 0x198;  
            }
            ...
            namespace C_INIT_CreateWithinSphereTransform {
                constexpr std::ptrdiff_t m_fRadiusMin = 0x1C8;  
                constexpr std::ptrdiff_t m_fRadiusMax = 0x328;  
                constexpr std::ptrdiff_t m_vecDistanceBias = 0x488;  
                constexpr std::ptrdiff_t m_vecDistanceBiasAbs = 0xB00;  
                constexpr std::ptrdiff_t m_TransformInput = 0xB10;  
                constexpr std::ptrdiff_t m_fSpeedMin = 0xB78;  
                constexpr std::ptrdiff_t m_fSpeedMax = 0xCD8;  
                constexpr std::ptrdiff_t m_fSpeedRandExp = 0xE38;  
                constexpr std::ptrdiff_t m_bLocalCoords = 0xE3C;  
                constexpr std::ptrdiff_t m_flEndCPGrowthTime = 0xE40;  
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMin = 0xE48;  
                constexpr std::ptrdiff_t m_LocalCoordinateSystemSpeedMax = 0x14C0;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1B38;  
                constexpr std::ptrdiff_t m_nFieldVelocity = 0x1B3C;  
            }
            ...
            namespace C_INIT_RemapScalarToVector {
                ...
                constexpr std::ptrdiff_t m_flInputMin = 0x1D0;  
                constexpr std::ptrdiff_t m_flInputMax = 0x1D4;  
                constexpr std::ptrdiff_t m_vecOutputMin = 0x1D8;  
                constexpr std::ptrdiff_t m_vecOutputMax = 0x1E4;  
                constexpr std::ptrdiff_t m_flStartTime = 0x1F0;  
                constexpr std::ptrdiff_t m_flEndTime = 0x1F4;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x1F8;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1FC;  
                constexpr std::ptrdiff_t m_bLocalCoords = 0x200;  
                constexpr std::ptrdiff_t m_flRemapBias = 0x204;  
            }
            namespace C_INIT_InitialSequenceFromModel {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1CC;  
                constexpr std::ptrdiff_t m_nFieldOutputAnim = 0x1D0;  
                constexpr std::ptrdiff_t m_flInputMin = 0x1D4;  
                constexpr std::ptrdiff_t m_flInputMax = 0x1D8;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1DC;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x1E0;  
            ...
            namespace C_OP_NoiseEmitter {
                constexpr std::ptrdiff_t m_flEmissionDuration = 0x1C8;  
                constexpr std::ptrdiff_t m_flStartTime = 0x1CC;  
                constexpr std::ptrdiff_t m_flEmissionScale = 0x1D0;  
                constexpr std::ptrdiff_t m_nScaleControlPoint = 0x1D4;  
                constexpr std::ptrdiff_t m_nScaleControlPointField = 0x1D8;  
                constexpr std::ptrdiff_t m_nWorldNoisePoint = 0x1DC;  
                ...
                constexpr std::ptrdiff_t m_flWorldNoiseScale = 0x1F4;  
                constexpr std::ptrdiff_t m_vecOffsetLoc = 0x1F8;  
                constexpr std::ptrdiff_t m_flWorldTimeScale = 0x204;  
            }
            namespace CParticleFunctionInitializer {
                constexpr std::ptrdiff_t m_nAssociatedEmitterIndex = 0x1C0;  
            }
            namespace C_OP_SelectivelyEnableChildren {
                constexpr std::ptrdiff_t m_nChildGroupID = 0x1C8;  
                constexpr std::ptrdiff_t m_nFirstChild = 0x328;  
                constexpr std::ptrdiff_t m_nNumChildrenToEnable = 0x488;  
                constexpr std::ptrdiff_t m_bPlayEndcapOnStop = 0x5E8;  
                constexpr std::ptrdiff_t m_bDestroyImmediately = 0x5E9;  
            }
            ...
            namespace C_OP_PlanarConstraint {
                ...
                constexpr std::ptrdiff_t m_flMaximumDistanceToCP = 0x340;  
                constexpr std::ptrdiff_t m_bUseOldCode = 0x4A0;  
            }
            namespace C_INIT_CreateFromCPs {
                constexpr std::ptrdiff_t m_nIncrement = 0x1C8;  
                constexpr std::ptrdiff_t m_nMinCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nMaxCP = 0x1D0;  
                constexpr std::ptrdiff_t m_nDynamicCPCount = 0x1D8;  
            }
            ...
            namespace C_INIT_CreateSpiralSphere {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_nOverrideCP = 0x1CC;  
                constexpr std::ptrdiff_t m_nDensity = 0x1D0;  
                constexpr std::ptrdiff_t m_flInitialRadius = 0x1D4;  
                constexpr std::ptrdiff_t m_flInitialSpeedMin = 0x1D8;  
                constexpr std::ptrdiff_t m_flInitialSpeedMax = 0x1DC;  
                constexpr std::ptrdiff_t m_bUseParticleCount = 0x1E0;  
            }
            ...
            namespace CParticleFloatInput {
                ...
                constexpr std::ptrdiff_t m_nBiasType = 0x114;  
                constexpr std::ptrdiff_t m_flBiasParameter = 0x118;  
                constexpr std::ptrdiff_t m_Curve = 0x120;  
            }
            namespace C_INIT_PointList {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_pointList = 0x1D0;  
                constexpr std::ptrdiff_t m_bPlaceAlongPath = 0x1E8;  
                constexpr std::ptrdiff_t m_bClosedLoop = 0x1E9;  
                constexpr std::ptrdiff_t m_nNumPointsAlongPath = 0x1EC;  
            }
            namespace C_OP_LerpToOtherAttribute {
                constexpr std::ptrdiff_t m_flInterpolation = 0x1C0;  
                constexpr std::ptrdiff_t m_nFieldInputFrom = 0x320;  
                constexpr std::ptrdiff_t m_nFieldInput = 0x324;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x328;  
            }
            namespace C_INIT_RandomColor {
                constexpr std::ptrdiff_t m_ColorMin = 0x1E4;  
                constexpr std::ptrdiff_t m_ColorMax = 0x1E8;  
                constexpr std::ptrdiff_t m_TintMin = 0x1EC;  
                constexpr std::ptrdiff_t m_TintMax = 0x1F0;  
                constexpr std::ptrdiff_t m_flTintPerc = 0x1F4;  
                constexpr std::ptrdiff_t m_flUpdateThreshold = 0x1F8;  
                constexpr std::ptrdiff_t m_nTintCP = 0x1FC;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x200;  
                constexpr std::ptrdiff_t m_nTintBlendMode = 0x204;  
                constexpr std::ptrdiff_t m_flLightAmplification = 0x208;  
            }
            ...
            namespace C_INIT_RemapParticleCountToScalar {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_nInputMin = 0x1CC;  
                constexpr std::ptrdiff_t m_nInputMax = 0x1D0;  
                constexpr std::ptrdiff_t m_nScaleControlPoint = 0x1D4;  
                constexpr std::ptrdiff_t m_nScaleControlPointField = 0x1D8;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1DC;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x1E0;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x1E4;  
                constexpr std::ptrdiff_t m_bActiveRange = 0x1E8;  
                constexpr std::ptrdiff_t m_bInvert = 0x1E9;  
                constexpr std::ptrdiff_t m_bWrap = 0x1EA;  
                constexpr std::ptrdiff_t m_flRemapBias = 0x1EC;  
            }
            namespace C_INIT_InheritFromParentParticles {
                constexpr std::ptrdiff_t m_flScale = 0x1C8;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1CC;  
                constexpr std::ptrdiff_t m_nIncrement = 0x1D0;  
                constexpr std::ptrdiff_t m_bRandomDistribution = 0x1D4;  
                constexpr std::ptrdiff_t m_nRandomSeed = 0x1D8;  
            }
            ...
            namespace C_INIT_ChaoticAttractor {
                constexpr std::ptrdiff_t m_flAParm = 0x1C8;  
                constexpr std::ptrdiff_t m_flBParm = 0x1CC;  
                constexpr std::ptrdiff_t m_flCParm = 0x1D0;  
                constexpr std::ptrdiff_t m_flDParm = 0x1D4;  
                constexpr std::ptrdiff_t m_flScale = 0x1D8;  
                constexpr std::ptrdiff_t m_flSpeedMin = 0x1DC;  
                constexpr std::ptrdiff_t m_flSpeedMax = 0x1E0;  
                constexpr std::ptrdiff_t m_nBaseCP = 0x1E4;  
                constexpr std::ptrdiff_t m_bUniformSpeed = 0x1E8;  
            }
            ...
            namespace C_OP_RenderFlattenGrass {
                constexpr std::ptrdiff_t m_flFlattenStrength = 0x210;  
                constexpr std::ptrdiff_t m_nStrengthFieldOverride = 0x214;  
                constexpr std::ptrdiff_t m_flRadiusScale = 0x218;  
            }
            namespace C_OP_RenderLightBeam {
                constexpr std::ptrdiff_t m_vColorBlend = 0x210;  
                constexpr std::ptrdiff_t m_nColorBlendType = 0x888;  
                constexpr std::ptrdiff_t m_flBrightnessLumensPerMeter = 0x890;  
                constexpr std::ptrdiff_t m_bCastShadows = 0x9F0;  
                constexpr std::ptrdiff_t m_flSkirt = 0x9F8;  
                constexpr std::ptrdiff_t m_flRange = 0xB58;  
                constexpr std::ptrdiff_t m_flThickness = 0xCB8;  
            }
            namespace C_OP_EnableChildrenFromParentParticleCount {
                constexpr std::ptrdiff_t m_nChildGroupID = 0x1C8;  
                constexpr std::ptrdiff_t m_nFirstChild = 0x1CC;  
                constexpr std::ptrdiff_t m_nNumChildrenToEnable = 0x1D0;  
            ...
            namespace C_INIT_DistanceToCPInit {
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1C8;  
                constexpr std::ptrdiff_t m_flInputMin = 0x1D0;  
                constexpr std::ptrdiff_t m_flInputMax = 0x330;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x490;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x5F0;  
                constexpr std::ptrdiff_t m_nStartCP = 0x750;  
                constexpr std::ptrdiff_t m_bLOS = 0x754;  
                constexpr std::ptrdiff_t m_CollisionGroupName = 0x755;  
                constexpr std::ptrdiff_t m_nTraceSet = 0x7D8;  
                constexpr std::ptrdiff_t m_flMaxTraceLength = 0x7E0;  
                constexpr std::ptrdiff_t m_flLOSScale = 0x940;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x944;  
                constexpr std::ptrdiff_t m_bActiveRange = 0x948;  
                constexpr std::ptrdiff_t m_vecDistanceScale = 0x94C;  
                constexpr std::ptrdiff_t m_flRemapBias = 0x958;  
            }
            namespace CReplicationParameters {
                ...
                constexpr std::ptrdiff_t m_flMaxRandomRadiusScale = 0x168;  
                constexpr std::ptrdiff_t m_vMinRandomDisplacement = 0x2C8;  
                constexpr std::ptrdiff_t m_vMaxRandomDisplacement = 0x940;  
                constexpr std::ptrdiff_t m_flModellingScale = 0xFB8;  
            }
            ...
            namespace C_INIT_SetRigidAttachment {
                ...
                constexpr std::ptrdiff_t m_nFieldInput = 0x1CC;  
                constexpr std::ptrdiff_t m_nFieldOutput = 0x1D0;  
                constexpr std::ptrdiff_t m_bLocalSpace = 0x1D4;  
            }
            ...
            namespace C_OP_RenderModels {
                constexpr std::ptrdiff_t m_bOnlyRenderInEffectsBloomPass = 0x210;  
                constexpr std::ptrdiff_t m_bOnlyRenderInEffectsWaterPass = 0x211;  
                constexpr std::ptrdiff_t m_bUseMixedResolutionRendering = 0x212;  
                constexpr std::ptrdiff_t m_bOnlyRenderInEffecsGameOverlay = 0x213;  
                constexpr std::ptrdiff_t m_ModelList = 0x218;  
                constexpr std::ptrdiff_t m_nBodyGroupField = 0x230;  
                constexpr std::ptrdiff_t m_nSubModelField = 0x234;  
                constexpr std::ptrdiff_t m_bIgnoreNormal = 0x238;  
                constexpr std::ptrdiff_t m_bOrientZ = 0x239;  
                constexpr std::ptrdiff_t m_bCenterOffset = 0x23A;  
                constexpr std::ptrdiff_t m_vecLocalOffset = 0x240;  
                constexpr std::ptrdiff_t m_vecLocalRotation = 0x8B8;  
                constexpr std::ptrdiff_t m_bIgnoreRadius = 0xF30;  
                constexpr std::ptrdiff_t m_nModelScaleCP = 0xF34;  
                constexpr std::ptrdiff_t m_vecComponentScale = 0xF38;  
                constexpr std::ptrdiff_t m_bLocalScale = 0x15B0;  
                constexpr std::ptrdiff_t m_nSizeCullBloat = 0x15B4;  
                constexpr std::ptrdiff_t m_bAnimated = 0x15B8;  
                constexpr std::ptrdiff_t m_flAnimationRate = 0x15C0;  
                constexpr std::ptrdiff_t m_bScaleAnimationRate = 0x1720;  
                constexpr std::ptrdiff_t m_bForceLoopingAnimation = 0x1721;  
                constexpr std::ptrdiff_t m_bResetAnimOnStop = 0x1722;  
                constexpr std::ptrdiff_t m_bManualAnimFrame = 0x1723;  
                constexpr std::ptrdiff_t m_nAnimationScaleField = 0x1724;  
                constexpr std::ptrdiff_t m_nAnimationField = 0x1728;  
                constexpr std::ptrdiff_t m_nManualFrameField = 0x172C;  
                constexpr std::ptrdiff_t m_ActivityName = 0x1730;  
                constexpr std::ptrdiff_t m_SequenceName = 0x1830;  
                constexpr std::ptrdiff_t m_bEnableClothSimulation = 0x1930;  
                constexpr std::ptrdiff_t m_ClothEffectName = 0x1931;  
                ...
                constexpr std::ptrdiff_t m_bSuppressTint = 0x1DC5;  
                constexpr std::ptrdiff_t m_nSubModelFieldType = 0x1DC8;  
                constexpr std::ptrdiff_t m_bDisableShadows = 0x1DCC;  
                constexpr std::ptrdiff_t m_bDisableDepthPrepass = 0x1DCD;  
                constexpr std::ptrdiff_t m_bAcceptsDecals = 0x1DCE;  
                constexpr std::ptrdiff_t m_bForceDrawInterlevedWithSiblings = 0x1DCF;  
                constexpr std::ptrdiff_t m_bDoNotDrawInParticlePass = 0x1DD0;  
                constexpr std::ptrdiff_t m_bAllowApproximateTransforms = 0x1DD1;  
                constexpr std::ptrdiff_t m_szRenderAttribute = 0x1DD2;  
                constexpr std::ptrdiff_t m_flRadiusScale = 0x1ED8;  
                constexpr std::ptrdiff_t m_flAlphaScale = 0x2038;  
                constexpr std::ptrdiff_t m_flRollScale = 0x2198;  
                constexpr std::ptrdiff_t m_nAlpha2Field = 0x22F8;  
                constexpr std::ptrdiff_t m_vecColorScale = 0x2300;  
            ...
            namespace C_OP_RenderClientPhysicsImpulse {
                ...
                constexpr std::ptrdiff_t m_flMagnitude = 0x370;  
                constexpr std::ptrdiff_t m_nSimIdFilter = 0x4D0;  
            }
            namespace CParticleFunctionEmitter {
                constexpr std::ptrdiff_t m_nEmitterIndex = 0x1C0;  
            }
            ...
            namespace C_OP_RopeSpringConstraint {
                ...
                constexpr std::ptrdiff_t m_flMinDistance = 0x320;  
                constexpr std::ptrdiff_t m_flMaxDistance = 0x480;  
                constexpr std::ptrdiff_t m_flAdjustmentScale = 0x5E0;  
                constexpr std::ptrdiff_t m_flInitialRestingLength = 0x5E8;  
            }
            namespace C_INIT_PositionWarpScalar {
                constexpr std::ptrdiff_t m_vecWarpMin = 0x1C8;  
                constexpr std::ptrdiff_t m_vecWarpMax = 0x1D4;  
                constexpr std::ptrdiff_t m_InputValue = 0x1E0;  
                constexpr std::ptrdiff_t m_flPrevPosScale = 0x340;  
                constexpr std::ptrdiff_t m_nScaleControlPointNumber = 0x344;  
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x348;  
            }
            namespace C_OP_ForceControlPointStub {
                constexpr std::ptrdiff_t m_ControlPoint = 0x1C8;  
            }
            ...
            namespace C_OP_RemapParticleCountToScalar {
                ...
                constexpr std::ptrdiff_t m_nInputMax = 0x328;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x488;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x5E8;  
                constexpr std::ptrdiff_t m_bActiveRange = 0x748;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x74C;  
            }
            ...
            namespace C_OP_RemapModelVolumetoCP {
                ...
                constexpr std::ptrdiff_t m_nInControlPointNumber = 0x1CC;  
                constexpr std::ptrdiff_t m_nOutControlPointNumber = 0x1D0;  
                constexpr std::ptrdiff_t m_nOutControlPointMaxNumber = 0x1D4;  
                constexpr std::ptrdiff_t m_nField = 0x1D8;  
                constexpr std::ptrdiff_t m_flInputMin = 0x1DC;  
                constexpr std::ptrdiff_t m_flInputMax = 0x1E0;  
                constexpr std::ptrdiff_t m_flOutputMin = 0x1E4;  
                constexpr std::ptrdiff_t m_flOutputMax = 0x1E8;  
                constexpr std::ptrdiff_t m_bBBoxOnly = 0x1EC;  
                constexpr std::ptrdiff_t m_bCubeRoot = 0x1ED;  
            }
            ...
            namespace C_OP_SetControlPointToCPVelocity {
                constexpr std::ptrdiff_t m_nCPInput = 0x1C8;  
                constexpr std::ptrdiff_t m_nCPOutputVel = 0x1CC;  
                constexpr std::ptrdiff_t m_bNormalize = 0x1D0;  
                constexpr std::ptrdiff_t m_nCPOutputMag = 0x1D4;  
                constexpr std::ptrdiff_t m_nCPField = 0x1D8;  
                constexpr std::ptrdiff_t m_vecComparisonVelocity = 0x1E0;  
            }
            namespace C_OP_ClientPhysics {
                constexpr std::ptrdiff_t m_strPhysicsType = 0x210;  
                constexpr std::ptrdiff_t m_bStartAsleep = 0x218;  
                constexpr std::ptrdiff_t m_flPlayerWakeRadius = 0x220;  
                constexpr std::ptrdiff_t m_flVehicleWakeRadius = 0x380;  
                constexpr std::ptrdiff_t m_bUseHighQualitySimulation = 0x4E0;  
                constexpr std::ptrdiff_t m_nMaxParticleCount = 0x4E4;  
                constexpr std::ptrdiff_t m_bRespectExclusionVolumes = 0x4E8;  
                constexpr std::ptrdiff_t m_bKillParticles = 0x4E9;  
                constexpr std::ptrdiff_t m_bDeleteSim = 0x4EA;  
                constexpr std::ptrdiff_t m_nControlPoint = 0x4EC;  
            ...
            namespace C_OP_ExternalWindForce {
                ...
                constexpr std::ptrdiff_t m_vecScale = 0x848;  
                constexpr std::ptrdiff_t m_bSampleWind = 0xEC0;  
                constexpr std::ptrdiff_t m_bSampleWater = 0xEC1;  
                constexpr std::ptrdiff_t m_bDampenNearWaterPlane = 0xEC2;  
                constexpr std::ptrdiff_t m_bSampleGravity = 0xEC3;  
                constexpr std::ptrdiff_t m_vecGravityForce = 0xEC8;  
                constexpr std::ptrdiff_t m_bUseBasicMovementGravity = 0x1540;  
                constexpr std::ptrdiff_t m_flLocalGravityScale = 0x1548;  
                constexpr std::ptrdiff_t m_flLocalBuoyancyScale = 0x16A8;  
                constexpr std::ptrdiff_t m_vecBuoyancyForce = 0x1808;  
            }
            namespace C_INIT_ModelCull {
                constexpr std::ptrdiff_t m_nControlPointNumber = 0x1C8;  
                constexpr std::ptrdiff_t m_bBoundBox = 0x1CC;  
                constexpr std::ptrdiff_t m_bCullOutside = 0x1CD;  
                constexpr std::ptrdiff_t m_bUseBones = 0x1CE;  
                constexpr std::ptrdiff_t m_HitboxSetName = 0x1CF;  
            }
            namespace C_OP_RenderSprites {
                constexpr std::ptrdiff_t m_nSequenceOverride = 0x2AA8;  
                constexpr std::ptrdiff_t m_nOrientationType = 0x2C08;  
                constexpr std::ptrdiff_t m_nOrientationControlPoint = 0x2C0C;  
                constexpr std::ptrdiff_t m_bUseYawWithNormalAligned = 0x2C10;  
                constexpr std::ptrdiff_t m_flMinSize = 0x2C18;  
                constexpr std::ptrdiff_t m_flMaxSize = 0x2D78;  
                constexpr std::ptrdiff_t m_flAlphaAdjustWithSizeAdjust = 0x2ED8;  
                constexpr std::ptrdiff_t m_flStartFadeSize = 0x3038;  
                constexpr std::ptrdiff_t m_flEndFadeSize = 0x3198;  
                constexpr std::ptrdiff_t m_flStartFadeDot = 0x32F8;  
                constexpr std::ptrdiff_t m_flEndFadeDot = 0x32FC;  
                constexpr std::ptrdiff_t m_bDistanceAlpha = 0x3300;  
                constexpr std::ptrdiff_t m_bSoftEdges = 0x3301;  
                constexpr std::ptrdiff_t m_flEdgeSoftnessStart = 0x3304;  
                constexpr std::ptrdiff_t m_flEdgeSoftnessEnd = 0x3308;  
                constexpr std::ptrdiff_t m_bOutline = 0x330C;  
                constexpr std::ptrdiff_t m_OutlineColor = 0x330D;  
                constexpr std::ptrdiff_t m_nOutlineAlpha = 0x3314;  
                constexpr std::ptrdiff_t m_flOutlineStart0 = 0x3318;  
                constexpr std::ptrdiff_t m_flOutlineStart1 = 0x331C;  
                constexpr std::ptrdiff_t m_flOutlineEnd0 = 0x3320;  
                constexpr std::ptrdiff_t m_flOutlineEnd1 = 0x3324;  
                constexpr std::ptrdiff_t m_nLightingMode = 0x3328;  
                constexpr std::ptrdiff_t m_flLightingTessellation = 0x3330;  
                constexpr std::ptrdiff_t m_flLightingDirectionality = 0x3490;  
                constexpr std::ptrdiff_t m_bParticleShadows = 0x35F0;  
                constexpr std::ptrdiff_t m_flShadowDensity = 0x35F4;  
            ...
            namespace C_OP_SetPerChildControlPoint {
                ...
                constexpr std::ptrdiff_t m_nFirstSourcePoint = 0x330;  
                constexpr std::ptrdiff_t m_bSetOrientation = 0x490;  
                constexpr std::ptrdiff_t m_nOrientationField = 0x494;  
                constexpr std::ptrdiff_t m_bNumBasedOnParticleCount = 0x498;  
            }
            namespace C_OP_RenderTreeShake {
                constexpr std::ptrdiff_t m_flPeakStrength = 0x210;  
                constexpr std::ptrdiff_t m_nPeakStrengthFieldOverride = 0x214;  
                constexpr std::ptrdiff_t m_flRadius = 0x218;  
                constexpr std::ptrdiff_t m_nRadiusFieldOverride = 0x21C;  
                constexpr std::ptrdiff_t m_flShakeDuration = 0x220;  
                constexpr std::ptrdiff_t m_flTransitionTime = 0x224;  
                constexpr std::ptrdiff_t m_flTwistAmount = 0x228;  
                constexpr std::ptrdiff_t m_flRadialAmount = 0x22C;  
                constexpr std::ptrdiff_t m_flControlPointOrientationAmount = 0x230;  
                constexpr std::ptrdiff_t m_nControlPointForLinearDirection = 0x234;  
            }
            ...
            namespace C_OP_SetAttributeToScalarExpression {
                ...
                constexpr std::ptrdiff_t m_flInput2 = 0x328;  
                constexpr std::ptrdiff_t m_flOutputRemap = 0x488;  
                constexpr std::ptrdiff_t m_nOutputField = 0x5E8;  
                constexpr std::ptrdiff_t m_nSetMethod = 0x5EC;  
            }
            ...
            namespace C_OP_RenderMaterialProxy {
                ...
                constexpr std::ptrdiff_t m_flAlpha = 0xA10;  
            ...
            namespace C_INIT_SequenceFromCP {
                constexpr std::ptrdiff_t m_bKillUnused = 0x1C8;  
                constexpr std::ptrdiff_t m_bRadiusScale = 0x1C9;  
                constexpr std::ptrdiff_t m_nCP = 0x1CC;  
                constexpr std::ptrdiff_t m_vecOffset = 0x1D0;  
            }
